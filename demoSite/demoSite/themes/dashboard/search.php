                            ...
                            <?php if($keyword == 'Users' || $keyword == 'users' || $keyword == 'user' || $keyword == 'user'|| $keyword == 'members'|| $keyword == 'Members'|| $keyword == 'member'|| $keyword == 'Member'):?>
                                <li>
                                    <div class="result-info" style="max-width:50%">
                                        ...
                                        <div class="">
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/user/add')?>"><i class="fa  fa-plus"></i> Add New User</a>
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/user/search')?>"><i class="fa  fa-search"></i> Search Users</a>
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/main/search/groups')?>"><i class="fa  fa-users"> User Groups</i></a>
                                        </div>
                                    </div>
                                </li>
                            <?php elseif($keyword == 'Pages' || $keyword == 'Website Pages' || $keyword == 'website pages' || $keyword == 'pages' || $keyword == 'Page' || $keyword == 'Website Page' || $keyword == 'website page' || $keyword == 'page'):?>
                                <li>
                                    <div class="result-info" style="max-width:50%">
                                        ...
                                        <div class="">
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/module/page/add')?>"><i class="fa  fa-plus"></i> Add Page</a>
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/module/page/show_pages')?>"><i class="fa  fa-file-o"></i> Show Pages</a>
                                        </div>
                                    </div>
                                </li>
                            <?php elseif($keyword == 'Groups' || $keyword == 'User Groups' || $keyword == 'user groups' || $keyword == 'groups' || $keyword == 'Group' || $keyword == 'User Group' || $keyword == 'user group' || $keyword == 'group'):?>
                                <li>
                                    <div class="result-info" style="max-width:50%">
                                        ...
                                        <div class="">
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/user/add_group')?>"><i class="fa  fa-plus"></i> Add New Group</a>
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/user/groups')?>"><i class="fa  fa-users"></i> Edit/Show Groups</a>
                                        </div>
                                    </div>
                                </li>
                            <?php elseif($keyword == 'Links' || $keyword == 'Navigation Links' || $keyword == 'navigation links' || $keyword == 'links' || $keyword == 'Navigation' || $keyword == 'navigation' || $keyword == 'Link' || $keyword == 'Navigation Link' || $keyword == 'navigation link' || $keyword == 'link'):?>
                                <li>
                                    <div class="result-info" style="max-width:50%">
                                        ...
                                        <div class="">
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/links/add')?>"><i class="fa  fa-plus"></i> Add New Link</a>
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/links/show')?>"><i class="fa  fa-users"></i> Edit/Show Links</a>
                                        </div>
                                    </div>
                                </li>
                            <?php elseif($keyword == 'Themes' || $keyword == 'Theme' || $keyword == 'Template' || $keyword == 'Templates' || $keyword == 'themes' || $keyword == 'theme' || $keyword == 'template' || $keyword == 'templates'):?>
                                <li>
                                    <div class="result-info" style="max-width:50%">
                                        ...
                                        <div class="">
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/themes/show')?>"><i class="fa  fa-th"></i> Edit/Show Themes</a>
                                        </div>
                                    </div>
                                </li>
                            <?php elseif($keyword == 'Settings' || $keyword == 'Website Settings' || $keyword == 'Search Engine settings' || $keyword == 'Edit/Show Modules' || $keyword == 'Options' || $keyword == 'Search engine' || $keyword == 'Web settings' || $keyword == 'settings' || $keyword == 'website settings' || $keyword == 'search engine settings' || $keyword == 'edit/show Modules' || $keyword == 'options' || $keyword == 'search engine' || $keyword == 'web settings'):?>
                                <li>
                                    <div class="result-info" style="max-width:50%">
                                        ...
                                        <div class="">
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/main/settings')?>"><i class="fa  fa-cogs"></i> Website Settings</a>
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/main/seo_settings')?>"><i class="fa  fa-google"></i> Search Engine Settings</a>
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/modules/show')?>"><i class="fa  fa-cube"></i> Edit/Show Modules</a>
                                        </div>
                                    </div>
                                </li>
                            <?php elseif($keyword == 'Files' || $keyword == 'File' || $keyword == 'files' || $keyword == 'file' || $keyword == 'files'  || $keyword == 'File Manager' || $keyword == 'file manager'):?>
                                <li>
                                    <div class="result-info" style="max-width:50%">
                                        ...
                                        <div class="">
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/files/show')?>"><i class="fa  fa-file"></i> File Manager</a>
                                        </div>
                                    </div>
                                </li>
                            <?php elseif($keyword == 'Modules' || $keyword == 'Module' || $keyword == 'modules' || $keyword == 'module'):?>
                                <li>
                                    <div class="result-info" style="max-width:50%">
                                        <h4 class="title"><a href="javascript:;">Module Section</a></h4>
                                        <p class="location">BuilderEngine main section</p>
                                        <p class="desc">
                                            In this section of the system you can manage all Modules installed.
                                        </p>
                                        <div class="">
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('/admin/modules/show')?>"><i class="fa  fa-cube"></i> Module Manager</a>
                                        </div>
                                    </div>
                                </li>
                            <?php else:?>
