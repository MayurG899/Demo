    ...
    $(document).ready(function () {
        $(document).find('input:file').each(function() {
            ...
            if(file != "" && typeof file !== 'undefined')
            {
                ...
                $('[name="'+this.name + '"]').parent().parent().append('<div class="profile-avatar" style="width:250px !important"><img style="max-width:100% !important; height:auto !important" class="file_preview" src="" alt="No Image" ></div>');
