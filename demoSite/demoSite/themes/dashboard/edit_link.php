			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Adjust This Navbar Menu Link</h4>
                        </div>
                            ...
                            <form class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" method="post" action="">
                                ...
                                <div class="form-group">
									<label class="control-label col-md-4 col-sm-4 col-be-4" for="fullname">
										...
										<b>Name:</b>
										<i class="fa fa-question-circle" style="font-size:16px;color: #AFAFAF;" data-toggle="tooltip" data-placement="top" title="Link Name"></i>
									</label>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<select class="form-control" name="tags" required >
											<option value="internal" <?php if($link->tags == 'internal')echo 'selected';?>>Internal (to this website)</option>
											<option value="external" <?php if($link->tags == 'external')echo 'selected';?>>External (to another website)</option>
										</select>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" id="linkmeta" name="title" placeholder="Leave blank if none."  value='<?php echo $link->title?>'/>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<button type="submit" class="btn btn-primary">Save Navbar Link</button>
									</div>
								</div>
                            </form>
                        </div>
                            ...
                            <div class="panel panel-grey">
                                ...
                                <div id="collapseQuide" class="panel-collapse collapse">
                                    <div class="panel-body panel-body-2">
                                        Adjust this menu button on your navbar, change usergroup access, position and is it on the menu or a dropdown option.
							...
							<ul class="todolist">
								...
								<li>
									<a href="javascript:;" class="todolist-container" data-click="todolist">
										<div class="todolist-input"><i class="fa fa-square-o"></i></div>
										<div class="todolist-title">Edit Navbar Link</div>
									</a>
								</li>
								<li>
									<a href="javascript:;" class="todolist-container" data-click="todolist">
