		...
		<div id="content" class="content">
				...
				<!-- begin col-cloud -->
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
						<div class="widget be-dashboard-widget-cloud widget-stats bg-white">
							...
							<div class="stats-title">INSTALL</div>
							<div class="stats-number">
								Website Themes
							</div>
			...
			<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 col-beadmin-12 be-dashboard-col-boxes-pad">
				...
				<!-- begin col-all -->
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
						<div class="widget widget-stats bg-grey-500">
							<div class="stats-icon stats-icon-lg be-dashboard-i-cloud"><a href="https://www.builderengine.com/guides/all_posts" target="_blank"><i class="fa fa-book fa-fw"></i></a></div>
							<div class="stats-title">SUPPORT</div>
							<div class="stats-number">
								Guides
							</div>
							<div class="stats-link"><a href="https://www.builderengine.com/guides/all_posts" target="_blank">Support Guides & Tutorials</div></a>
						</div>
					</div>
				<!-- end col-all -->
				<!-- begin col-all -->
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
						<div class="widget widget-stats bg-grey-500">
							<div class="stats-icon stats-icon-lg be-dashboard-i-cloud"><a href="https://www.builderengine.com/videotube/all_videos" target="_blank"><i class="fa fa-video-camera fa-fw"></i></a></div>
							<div class="stats-title">VIDEO</div>
							<div class="stats-number">
								Tutorials
							</div>
							<div class="stats-link"><a href="https://www.builderengine.com/videotube/all_videos" target="_blank">View Video Tutorials</div></a>
						</div>
					</div>
				<!-- end col-all -->
				<!-- begin col-all -->
				...
				<!-- begin col-all -->
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
						<div class="widget widget-stats bg-grey-500">
							<div class="stats-icon stats-icon-lg be-dashboard-i-cloud"><a href="https://www.builderengine.org/forum/all_topics" target="_blank"><i class="fa fa-coffee fa-fw"></i></a></div>
							<div class="stats-title">FORUMS</div>
							<div class="stats-number">
								Community
							</div>
							<div class="stats-link"><a href="https://www.builderengine.org/forum/all_topics" target="_blank">View Community Forums</div></a>
						</div>
					</div>
				<!-- end col-all -->
				<!-- begin col-all -->
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
						<div class="widget widget-stats bg-grey-500">
							<div class="stats-icon stats-icon-lg be-dashboard-i-cloud"><a href="https://builderengine.org/page-template-themes.html" target="_blank"><i class="fa fa-th fa-fw"></i></a></div>
							<div class="stats-title">DESIGN</div>
							<div class="stats-number">
								Templates
							</div>
							<div class="stats-link"><a href="https://builderengine.org/page-template-themes.html" target="_blank">Download New Themes</div></a>
						</div>
					</div>
				<!-- end col-all -->
				<!-- begin col-2 -->
								...
								<table class="table">
									...
									<tbody>
										<tr>
											...
											<td>
												<h5><a href="#">Cloud: <b><?=$this->BuilderEngine->get_option('version');?></b></a></h5>
											</td>
										</tr>
										<tr>
											<td><h5>30 / 01 / 2018</td>
