        ...
        <div class="col-md-7">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Update Website / Progress Console</h4>
                </div>
                <div class="panel-body panel-form">

                    <h2 class="text-center">System Updates</h2>
                    <p class="text-center">
                        New Updates are available for your system. We recommend that you update your website to get bug fixes and improvements.
                    </p>
...
<script type="text/javascript">
    ...
    function update_phase_six(){
        ...
        $.post('<?=base_url()?>/index.php/admin/update/finish', _data, function (data) {
            if(data.result){
                ...
                if(updates.cursor.get_next()){
					...
					$('#btn_proceed').text('System Updated !');
                }
            }
    ...
    function update_phase_five(){
        ...
        $.get('<?=base_url()?>/index.php/admin/update/update_db', function (data) {
            if(data.result){
                $( "#status_message p:last").html(
    ...
    function update_phase_four(){
        ...
        $.get('<?=base_url()?>/index.php/admin/update/update_files', function (data) {
            if(data.result){
                $( "#status_message p:last").html(
    ...
    $('#backupModal').on('hidden.bs.modal', function (e) {
        if(do_backup){
            do_backup = false;
            $.post('<?=base_url()?>/index.php/admin/update/set_backup',{file_set: JSON.stringify(files)} , function (data) {
                $( "#status_message p:last").html(
    ...
    function update_phase_two(){
        ...
        _update = updates.cursor.get_current();
        $.post('<?=base_url()?>/index.php/admin/update/download/',{ver: _update.goal, asked: JSON.stringify(asked_files)} , function (data) {
            if(data.result){
                set_progress(30);
    ...
    window.onload = function(){
        ...
        $('#btn_proceed').click(function(){
            ...
            $.get('<?=base_url()?>/index.php/admin/update/prepare_update', function (data) {
                if(data.result){
