...
<ul class="nav">
	...
	<li class="has-sub">
        ...
        <ul class="sub-menu" <?php if(isset($current_page) && $current_page == 'templates') echo 'style="display:block"';?>>
			...
			<li><a href="https://www.builderengine.com/account/themes_control" target="_blank">New Themes From Marketplace</a></li>
        </ul>
    </li>
...
<ul class="nav">
	<li class="has-sub beweboptions">
		...
		<ul class="sub-menu beweboptions-sub" <?php if(isset($current_page) && $current_page == 'members' || $current_page == 'users' || $current_page == 'accountdashboard' || $current_page == 'groups') echo 'style="display:block"';?>>
	<li class="has-sub">
        <a href="javascript:;">
            <b class="caret pull-right"></b>
	...
	<li class="has-sub beweboptions">
		...
		<ul class="sub-menu beweboptions-sub" <?php if(isset($current_page) && ($current_page == 'ecommerce' || $current_page == 'classifieds')) echo 'style="display:block"';?>>
			<li class="has-sub">
				...
				<ul class="sub-menu" <?php if(isset($current_page) && $current_page == 'ecommerce') echo 'style="display:block"';?>>
					<hr>
					<li class="has-sub">
					...
					<li class="has-sub">
						...
						<ul class="sub-menu" <?php if(isset($current_page) && $current_page == 'ecommerce' && isset($current_child_page) && $current_child_page == 'Ecommerce_product') echo 'style="display:block"';?>>
					...
					<li class="has-sub">
						...
						<ul class="sub-menu" <?php if(isset($current_page) && $current_page == 'ecommerce' && isset($current_child_page) && $current_child_page == 'Ecommerce_category') echo 'style="display:block"';?>>
					...
					<li class="has-sub">
						...
						<ul class="sub-menu" <?php if(isset($current_page) && $current_page == 'ecommerce' && isset($current_child_page) && $current_child_page == 'Ecommerce_shipping') echo 'style="display:block"';?>>
					...
					<li class="has-sub">
						...
						<ul class="sub-menu" <?php if(isset($current_page) && $current_page == 'ecommerce' && isset($current_child_page) && ($current_child_page == 'ecommerce_checkout_fields' || $current_child_page == 'invoice_settings')) echo 'style="display:block"';?>>
...
<?
	if(file_exists($_SERVER['DOCUMENT_ROOT'].'/themes/dashboard/sidebar_custom.php'))
		require_once('sidebar_custom.php');
?>
<!-- end sidebar nav -->
