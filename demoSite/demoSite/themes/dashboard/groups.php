                    ...
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <div class="btn-group pull-right">
                                <a <?php echo href('admin', 'user/edit_group/'.$group->id)?> class="btn btn-success btn-xs">Edit Usergroup</a>
								<?php if($group->name == 'Administrators' || $group->name == 'Members' || $group->name == 'Guests'):?>
								<?php else:?>
                            	<a <?php echo href('admin', 'user/delete_group/'.$group->id)?> class="btn btn-danger btn-xs">Delete Usergroup</a>
								<?php endif;?>
                            </div>
							<?php $label = ($this->BuilderEngine->get_option('default_registration_group') == $group->name)?' &nbsp;&nbsp;<span class="label label-warning">Default Usergroup</span>':'';?>
                            ...
                            <div class="panel panel-grey">
                                ...
                                <div id="collapseQuide" class="panel-collapse collapse">
                                    <div class="panel-body panel-body-2">
                                        View all usegroups that you can assign users (members) to it and control what members can & can not do.<br><br>
							...
							<ul class="todolist">
								<li class="active">
									<a href="javascript:;" class="todolist-container active" data-click="todolist">
										...
										<div class="todolist-title">Usergroups</div>
									</a>
								</li>
								<li>
								...
								<li>
									<a href="javascript:;" class="todolist-container" data-click="todolist">
										<div class="todolist-input"><i class="fa fa-square-o"></i></div>
										<div class="todolist-title">Edit Usergroups</div>
									</a>
								</li>
								<li>
									<a href="javascript:;" class="todolist-container" data-click="todolist">
										<div class="todolist-input"><i class="fa fa-square-o"></i></div>
										<div class="todolist-title">Delete Usergroups</div>
									</a>
								</li>
								<li>
									<a href="javascript:;" class="todolist-container" data-click="todolist">
										<div class="todolist-input"><i class="fa fa-square-o"></i></div>
										<div class="todolist-title">Add New Usergroups</div>
									</a>
								</li>
							</ul>
						</div>
