...
<div id="content" class="content page-with-two-sidebar content-two-sidebars" style="min-height:800px">
			       ...
			       <!-- begin panel -->
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Installed Modules & Configuration Settings</h4>
                        </div>
                            ...
                            <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                	<?php foreach($modules as $module):?>
										<?php if($module->folder != 'page' && $module->folder != 'layout_system' ):?>
	                                    <tr>
	                                        <td><?php echo $module->name?></td>
	                                        <td><?php echo $module->version?></td>
	                                        <td>modules/<?php echo $module->folder?></td>
											<td><?php 
											if($module->installer_id == 0 || $module->installer_id == -1) 
												echo 'System';
											else 
											{
												$user = new User($module->installer_id); 
												echo $user->username;
											}
											?></td>
											<td><?php echo date('d/M/Y H:i:s', $module->install_time)?></td>
											<td>
												<?php if($module->name != 'Page' && $module->name != NULL):?>
												<div class="btn-group-vertical">
													<a href="<?=base_url()?>admin/modules/edit/<?php echo $module->id?>" class="btn btn-sm btn-success" style="margin-bottom:2px;"><i class="fa fa-edit"></i> Edit</a>
												</div>
												<div class="btn-group-vertical">
													<a href="<?=base_url()?>admin/modules/delete/<?php echo $module->id?>" class="btn btn-sm btn-inverse"><i class="fa fa-remove"></i> Delete</a>
												</div>
												<?php endif;?>
											</td>
	                                    </tr>
		...
		<div id="sidebar-right" class="sidebar sidebar-right">
			...
			<div data-scrollbar="true" data-height="100%">
				<!-- begin sidebar user -->
				<ul class="nav m-t-10">
					<h4 class="sidebar-right-main-title">Installed Modules</h4>
					<li class="nav-widget">
