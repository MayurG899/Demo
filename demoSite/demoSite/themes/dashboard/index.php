        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                <div class="news-image">
                    <img src="<?php echo $url?>" data-id="login-cover-image" alt="" />
                </div>
                <div class="news-caption">
                    <h4 class="caption-title"><i class="fa fa-compass text-default"></i> BuilderEngine Administration Dashboard</h4>
                    <p>
                        Welcome to the Administration Control Panel for your Website. Please login to access the Administration Dashboard.
                    </p>
                </div>
            </div>
            <!-- end news-feed -->
            ...
            <div class="right-content">
                ...
                <div class="login-header">
                    <div class="brand">
                        <span class=""></span> <h1><i class="fa fa-compass text-default"></i> Admin Account</h1>
                        <small>Login to your BuilderEngine Dashboard</small>
                    </div>
                    <div class="icon">
                        <i class="fa fa-sign-in" style="margin-top: 10px;"></i>
                    </div>
                </div>
                <!-- end login-header -->
                <!-- begin login-content -->
                    ...
                    <form action="#" method="POST" class="margin-bottom-0">
						...
						<?if($this->BuilderEngine->get_option('login_count_attempts') == 'yes'):?>
							<div id="securityAlert" class="alert alert-danger m-t-20" style="display:none">
								...
								<?$hours = (($this->BuilderEngine->get_option('login_attempt_expire')/60)/60);?>
								<p>
									...
									Please,contact <span data-toggle="tooltip" data-placement="top" title="<?=$this->BuilderEngine->get_option('adminemail');?>"><strong>Admin</strong> </span> or try again in <?=$hours;?> hours.
								</p>
							</div>
						<?endif;?>
                        <div class="m-t-20">
                        ...
                        <p class="text-center text-inverse">
                            &copy; BuilderEngine Ltd. All Right Reserved 2012-2017
                        </p>
                    </form>
                                ...
                                <form method="post">
                                    <div class="modal-body" style="min-height: 160px;">
                                        <div class="form-group m-b-20">
                                            ...
                                            <input style="color:#000;width:75%;background: #fff;border: 1px solid rgba(0,0,0,0.4);" type="email" class="form-control form-control-be-40 input-lg" name="email" placeholder="Email Address"/>
                                        </div>
                                    </div>
