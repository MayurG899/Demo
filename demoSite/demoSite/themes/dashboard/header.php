...
<head>
    ...
    <link href="<?php echo get_theme_path()?>assets/plugins/jquery-ui/themes/base/minified/jquery-ui.min.css" rel="stylesheet" />
    <link href="<?php echo get_theme_path()?>assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
    <link href="<?php echo get_theme_path()?>assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
    <link href="<?php echo get_theme_path()?>assets/css/animate.min.css" rel="stylesheet" />
    <link href="<?php echo get_theme_path()?>assets/css/style.css" rel="stylesheet" />
    <link href="<?php echo get_theme_path()?>assets/css/style-responsive.css" rel="stylesheet" />
    <link href="<?php echo get_theme_path()?>assets/css/theme/default.css" rel="stylesheet" id="theme" />
    <!-- ================== END BASE CSS STYLE ================== -->
	...
	<link href="<?php echo get_theme_path()?>assets/plugins/bootstrap-eonasdan-datetimepicker/build/css/bootstrap-datetimepicker.min.css" rel="stylesheet" />
	<link href="<?php echo get_theme_path()?>assets/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css" rel="stylesheet" />
	...
	<link href="<?php echo get_theme_path()?>assets/plugins/parsley/src/parsley.css" rel="stylesheet" />
	<link href="<?php echo get_theme_path()?>assets/plugins/sweet-alert/sweetalert.css" rel="stylesheet" />
    ...
    <div id="header" class="header navbar navbar-inverse navbar-fixed-top">
        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle f-s-20">
                        ...
                        <?php if(isset($user) && !empty($user)):?>
                            ...
                            <?php else:?>
                                <?php foreach($this->user->alert->get()->all as $alert): ?>
                                    <li class="media">
										<?php if($alert->url == '/admin/update/index'):?>
											<a href="<?php echo str_replace('/admin',base_url().'admin',$alert->url)?>">
										<?php else:?>
											<a href="<?php echo $alert->url?>">
										<?php endif;?>
                                            <div class="pull-left media-object bg-blue" style="margin-right:5px"><i class="fa <?php echo $alert->icon?>"></i></div>
                ...
                <li class="dropdown navbar-user">
                    ...
                    <ul class="dropdown-menu animated fadeInLeft">
                        <li class="arrow"></li>
                        <li><a <?=href("admin", "user/edit/{$this->user->get_id()}")?> ><i class="fa fa-edit"></i> Edit My Profile</a></li>
                        <li><a <?php echo href("admin", "main/settings")?>><i class="fa fa-cog"></i> Settings</a></li>
						<li><a href="<?=base_url('cp/dashboard')?>"><i class="fa fa-dashboard"></i> Account Dashboard</a></li>
                        <li><a href="<?=base_url('admin/main/statistics')?>" ><i class="fa fa-line-chart"></i> Website Statistics</a></li>
                        <li class="divider"></li>
                        <li><a href="<?=base_url('admin/main/logout')?>"><i class="fa fa-sign-out"></i> Log Out</a></li>
                    </ul>
                </li>
