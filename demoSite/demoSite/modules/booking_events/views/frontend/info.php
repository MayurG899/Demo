    ...
    <div class="row">
        <div class="col-md-12" style="padding-top:50px;">
				...
				<div class="col-md-12">
					<div class="alert alert-danger">
						...
						<div class="brand-logo">
							<img src="<?=$this->BuilderEngine->get_option('be_booking_events_company_logo')?>" alt="">
						</div><br/>
			...
			<div class="text-center" style="padding:50px 50px 100px 50px;">
				<a class="btn btn-lg btn-success" href="<?=base_url('booking_events/events')?>"><i class="fa fa-arrow-left"></i> Back to Events</a>
			</div>
        </div>
    </div>
</div>