    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">View All Events Created</h4>
            </div>
            <div class="panel-body">
				<form id="deleteForm" action="<?=base_url('admin/module/booking_events/bulk_delete/Booking_event/show_events')?>" method="POST">
					<a href="<?=base_url('admin/module/booking_events/add_event')?>" class="btn btn-sm btn-success m-r-10" style="float:left"><i class="fa fa-plus"></i> Add New Event</a>
					<button type="submit" id="deleteChecked" name="bulkDelete" class="btn btn-sm btn-danger" style="display:none" ><i class="fa fa-trash"></i> Delete Events(s)</button>
					<br/><br/>
					<div class="table">
						<table id="data-table-checkbox" class="table table-striped table-bordered table-hover">
							...
							<tbody>
							   <?php foreach($objects as $event):?>
								<tr class="odd gradeX" data-id="<?=$event->id?>">
									<td></td>
									...
									<td>
										<div style="width:80px">
											<a href="<?=base_url()?>booking_events/event/<?=$event->slug?>" type="button" class="btn btn-xs btn-primary" target="_blank" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a>
											<a href="<?=base_url()?>admin/module/booking_events/modify_object/Booking_event/<?=$event->id?>" type="button" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
											<a href="<?=base_url()?>admin/module/booking_events/delete_object/Booking_event/<?=$event->id?>" type="button" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
										</div>
									</td>
								</tr>
							  <?php endforeach;?>
