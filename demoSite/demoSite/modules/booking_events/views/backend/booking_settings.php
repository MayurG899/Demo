    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Booking Events Main Settings</h4>
            </div>
            <div class="panel-body panel-form">
                <form class="form-horizontal form-bordered" method="post" data-parsley-validate="true" name="demo-form">
					<div class="form-group" id="visible">
						<label class="control-label col-md-4 col-sm-4 col-be-4" for="forum_active">Booking Events Module Active:</label>
						<div class="col-md-6 col-sm-6">
							<?php if($this->BuilderEngine->get_option('booking_events_active') == 'yes')
						   	{
						   		$check1 = 'checked'; 
						   		$check2 = '';
						   	}
							...
							<label class="radio-inline">
                                <input type="radio" name="booking_events_active" id="disabled" value="yes" <?=$check1?>/>
                                Yes
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="booking_events_active" id="active" value="no" <?=$check2?>/>
                               No
                            </label>
						</div>
					</div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <select class="form-control" name="default_currency">
                                <?foreach ($currencies->get() as $currency) :?>
                                    <?if($currency->id == $this->BuilderEngine->get_option('be_booking_events_default_currency')):?>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<?php if($this->BuilderEngine->get_option('booking_events_permission') == 'yes')
						   	{
						   		$check1 = 'checked'; 
						   		$check2 = '';
						   	}
							...
							?>									
							<label class="radio-inline">
                                <input type="radio" name="booking_events_permission" id="public" value="yes" <?=$check1?>/>
                                Yes
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="booking_events_permission" id="private" value="no" <?=$check2?>/>
                                No
                            </label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<?
								...
								$active_method = $this->BuilderEngine->get_option('be_booking_events_payment_methods');
							?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-sm-8">
                                <ul id="shop-groups">
                                    <?php $groups = explode(',', $this->BuilderEngine->get_option('be_booking_events_shop_groups'));?>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-be-4" for="website"><b>Usergroups Allowed to Add Events:</b></label>
                        <div class="form-group">
                            <div class="col-md-8 col-sm-8">
                                <ul id="event-groups">
                                    <?php $groups = explode(',', $this->BuilderEngine->get_option('be_booking_events_add_event_groups'));?>
                                    <?php foreach($groups as $group):?>
                                        <li><?=$group?></li>
                                    <?php endforeach?>
                            </div>
					...
					*/?>
					<div class="form-group">
						...
						<div class="col-md-8 col-sm-8">
                            <ul id="access-groups">
		                      <?php $groups = explode(',', $this->BuilderEngine->get_option('be_booking_events_access_groups'));?>
		                      <?php foreach($groups as $group):?>
		                      	<li><?=$group?></li>
		                      <?php endforeach?>
							</div>
					...
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 col-be-4" for="active">
							<b>Reserve Booking Event Dates:</b>
							<i class="fa fa-question-circle" style="font-size:16px;color: #AFAFAF;" data-toggle="tooltip" data-placement="top" title="Reserve Booking Event Dates in range given"></i>
						</label>
						<?php
							$event_block_start = $this->BuilderEngine->get_option('be_booking_event_block_start_date');
							$event_block_end = $this->BuilderEngine->get_option('be_booking_event_block_end_date');
						?>
						<div class="col-md-8 col-sm-8">
						<div class="row">
							...
							<div class="col-md-6">
								<input type="text" class="form-control form-control-100 price" name="event_block_start_date" value="<?php if(!empty($event_block_start)) echo $event_block_start;?>" id="bookingSettingEventStartDate" placeholder="Start date" />
							</div>
							</div>
							<div class="row">
							...
							<div class="col-md-6">
								<input type="text" class="form-control form-control-100 price" name="event_block_end_date" value="<?php if(!empty($event_block_end)) echo $event_block_end;?>" id="bookingSettingEventEndDate" placeholder="End date" />
							</div>	
							</div>
						</div>
					</div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                                <input type="text" name="terms_conditions_url" class="required form-control" value="<?=$this->BuilderEngine->get_option('be_booking_events_settings_url')?>">
                        </div>
                    </div>
					<?/*
					<div class="form-group">
					...
					*/?>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<button type="submit" class="suBtn btn btn-primary">Save Booking Events Settings</button>
						</div>
					</div>
                </form>
            </div>
