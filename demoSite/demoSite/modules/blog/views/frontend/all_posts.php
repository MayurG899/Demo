...
<div id="blog-wrapper">
	...
	<div class="col-md-12">
		<div class="blog-nav-title">
				<h3><?=$BuilderEngine->get_option('website_title');?> Blog</h3>

				<ul class="be-breadcrumb">
					<li><a href="<?=base_url()?>">Home</a></li>
                    <li><a href="<?=base_url()?>blog/all_posts">Blog</a></li>
                    <li class="active">Published Blog Posts</li>
				</ul>
		</div>
	</div>
	</div>
							...
							<li class="masonry-item block-colors-light-bg">
								...
								<div class="item">
									<div class="item-title">
										<h3><a href="<?=base_url('blog/post').'/'.$post->slug?>"> <?=str_replace('_',' ',$post->title)?></a></h3>
