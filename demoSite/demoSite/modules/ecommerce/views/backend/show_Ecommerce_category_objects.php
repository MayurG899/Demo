	...
	<!-- begin panel -->
        <div class="panel panel-white">
			<div class="panel-heading">
				...
				<h4 class="panel-title">View All Store Categories</h4>
			</div>
            <div class="panel-body">
				<form id="deleteForm" action="<?=base_url('admin/module/ecommerce/bulk_delete/Ecommerce_category/show_categories')?>" method="POST">
					<a href="<?=base_url('admin/module/ecommerce/add_category')?>" class="btn btn-sm btn-success m-r-10" style="float:left"><i class="fa fa-plus"></i> Add New Store Category</a>
						...
						<table id="data-table-checkbox" class="table table-striped table-bordered table-hover">
							...
							<?foreach($objects as $object): ?>
								<tr data-id="<?=$object->id?>">
									...
									<td><?=$object->name?></td>
									<td><?=$object->parent?></td>
									<td><img class="img-responsive" style="max-width:100px;" src="<?=checkImagePath($object->image)?>" /></td>
									<td> 
									   <a href="<?=base_url()?>admin/module/ecommerce/modify_object/Ecommerce_category/<?=$object->id?>" class="btn btn-xs btn-success" type="button"  data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
									   <a href="<?=base_url()?>admin/module/ecommerce/delete_object/Ecommerce_category/<?=$object->id?>" type="button" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
							<?endforeach;?>
							</tbody>
