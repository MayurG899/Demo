	...
	<!-- begin panel -->
        <div class="panel panel-white">
			<div class="panel-heading">
				...
				<h4 class="panel-title">View All Store Shipping Options</h4>
			</div>
            <div class="panel-body">
				<form id="deleteForm" action="<?=base_url('admin/module/ecommerce/bulk_delete/Ecommerce_shipping/show_shippings')?>" method="POST">
					<a href="<?=base_url('admin/module/ecommerce/add_product')?>" class="btn btn-sm btn-success m-r-10" style="float:left"><i class="fa fa-plus"></i>Add New Store Shipping Option</a>
					<button type="submit" id="deleteChecked" name="bulkDelete" class="btn btn-sm btn-danger" style="display:none" ><i class="fa fa-trash"></i> Delete Shipping Option(s)</button>
					<br/><br/>
							...
							<?foreach($objects as $object): ?>
								<?if((int)$object->id !== 1):?>
									<tr data-id="<?=$object->id?>">
										...
										<?endif;?>
										<td>
											<a href="<?=base_url()?>admin/module/ecommerce/modify_object/Ecommerce_shipping/<?=$object->id?>" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
											<a href="<?=base_url()?>admin/module/ecommerce/delete_object/Ecommerce_shipping/<?=$object->id?>" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
										</td>
									</tr>
								<?endif;?>
							<?endforeach;?>
