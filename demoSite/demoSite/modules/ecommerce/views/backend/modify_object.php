...
<!--<script src="<?=get_theme_path()?>assets/plugins/forms/uniform/jquery.uniform.min.js"></script>
<script src="<?=get_theme_path()?>assets/plugins/forms/validation/jquery.validate.js"></script>
<script src="<?=get_theme_path()?>assets/plugins/forms/select2/select2.js"></script> 
<script src="<?=get_theme_path()?>assets/plugins/form-validation.js"></script>
<link href="<?=get_theme_path()?>assets/plugins/forms/select2/select2.css" rel="stylesheet" />
<script src="<?=get_theme_path()?>assets/plugins/file_manager.js"></script>-->
