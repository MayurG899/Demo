...
<script>
	...
	$('#versions-close').on('click',function(){
        ...
        <div class="row" style="position:relative">
            ...
            <div class="col-md-12">
			  ...
			  <div class="panel panel-default">
                        ...
                        <h4>Global Header & Footer Versions</h4>

                        <?php else:?>

                        <h4>Current Page - Saved Versions</h4>
                            ...
                            <div class="table">
                                ...
                                <table id="dataTable" class="table table-striped table-bordered">
                                    ...
                                    <thead>
                                        ...
                                        <tr><th>Page Name</th><th>Creator</th><th>Approver</th><th>Date</th><th>Actions</th></tr>
