    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">PayPal Payments - Main Settings</h4>
            </div>
			<div class="panel-body panel-form">
				<form class="form-horizontal form-bordered" method="post" data-parsley-validate="true" name="demo-form">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4" for="paypaladdress">Paypal Address:</label>
						<div class="col-md-6 col-sm-6">
							<input class="form-control" type="text" value="<?=$settings->paypal_address?>" id="paypaladdress" name="paypal_address" placeholder="Enter Your PayPal Account Email Address Here" data-parsley-required="true" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4" for="activepaypal">Active PayPal</label>
						<div class="form-group">
							<div class="col-md-2 col-sm-2">
								<select class="form-control" id="select-required" name="active" data-parsley-required="true">                
									<option value='yes' <?php if(!empty($settings->active) && $settings->active == 'yes') echo "selected"?>>Yes</option>						
									<option value='no' <?php if($settings->active == 'no') echo "selected"?>>No</option>							
								</select>
							</div>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4" for="sandbox">Sandbox</label>
						<div class="form-group">
							<div class="col-md-2 col-sm-2">
								<select class="form-control" id="select-required" name="sandbox" data-parsley-required="true">
									<option value='1' <?php if(!empty($settings->sandbox) && $settings->sandbox == 1) echo "selected"?>>Yes</option>
									<option value='0' <?php if($settings->sandbox == '0') echo "selected"?>>No</option>
								</select>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<button type="submit" class="btn btn-primary" value="Save Settings">Save PayPal Details</button>
						</div>
					</div>
				</form>
			</div>
...
<!-- begin #sidebar-right -->
		<div id="sidebar-right" class="sidebar sidebar-right">
			...
			<div data-scrollbar="true" data-height="100%">
				<!-- begin sidebar user -->
				<ul class="nav m-t-10">
					<h4 class="sidebar-right-main-title">PayPal Payments</h4>
					<li class="nav-widget">
                            ...
                            <div class="panel panel-grey">
                                ...
                                <div id="collapseQuide" class="panel-collapse collapse">
                                    <div class="panel-body panel-body-2">
                                        Setup your PayPal Details for your Website. <br><br>
										Enter your PayPal Email Address & activate the gateway.
							...
							<ul class="todolist">
								<li class="active">
									<a href="javascript:;" class="todolist-container active" data-click="todolist">
										...
										<div class="todolist-title">PayPal Payments</div>
									</a>
								</li>
								<li>
									<a href="javascript:;" class="todolist-container" data-click="todolist">
										<div class="todolist-input"><i class="fa fa-square-o"></i></div>
										<div class="todolist-title">Enter PayPal Email</div>
									</a>
								</li>
								<li>
									<a href="javascript:;" class="todolist-container" data-click="todolist">
