					...
					<div class="col-md-12">
						<form class="form-horizontal form-bordered" data-parsley-validate="true" method="post" enctype="multipart/form-data" name="post">
							<div class="form-group">
								<label class="control-label col-md-4 col-sm-4" for="required">Amount:</label>
								<div class="col-md-8 col-sm-8">
									<input type="text" name="amount" class="form-control" placeholder="0" min="0" max="20000000000" step="100" data-parsley-validation-threshold="1" data-parsley-trigger="keyup" data-parsley-type="number" value="" data-parsley-required="true">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-4 col-sm-4" for="required">From:</label>
								<div class="col-md-8 col-sm-8">
									<select name="from" class="form-control">
										<?$currencies = new Currency();?>
										<?foreach($currencies->get() as $currency):?>
											<option value="<?=$currency->signature?>"><?=$currency->name?></option>
										<?endforeach;?>
									</select>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-4 col-sm-4" for="required">To:</label>
								<div class="col-md-8 col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8">
									<div class="row">
										<div class="col-md-3">
											<button type="submit" class="btn btn-sm btn-success" name="convert"><i class="fa fa-refresh"></i> Convert</button>
										</div>
										<div class="col-md-9">
											<?if(!empty($result)):?>
												<div class="alert alert-success">
													<p class="lead"><?=$amount.' '.$from.' = '.$result.' '.$to?></p>
												</div>
											<?endif;?>
										</div>
									</div>
...
<!-- begin #sidebar-right -->
		<div id="sidebar-right" class="sidebar sidebar-right">
			...
			<div data-scrollbar="true" data-height="100%">
				<!-- begin sidebar user -->
				<ul class="nav m-t-10">
					<h4 class="sidebar-right-main-title">Currency Converter</h4>
					<li class="nav-widget">
                            ...
                            <div class="panel panel-grey">
                                ...
                                <div id="collapseQuide" class="panel-collapse collapse">
                                    <div class="panel-body panel-body-2">
                                        View the conversation rate between currencies for your website.
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-grey">
							...
							<ul class="todolist">
								<li class="active">
									<a href="javascript:;" class="todolist-container active" data-click="todolist">
										...
										<div class="todolist-title">Currency Converter</div>
									</a>
								</li>
								<li>
									<a href="javascript:;" class="todolist-container" data-click="todolist">
										<div class="todolist-input"><i class="fa fa-square-o"></i></div>
										<div class="todolist-title">Try Converter</div>
									</a>
								</li>
							</ul>
						</div>
