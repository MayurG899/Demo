...
<div class="container">
<div class="content">
<img src="<?=base_url('modules/builderpayment/img/gateways/authorizenet/authorizenet.png')?>" style="margin-top: 10px;width: 250px;float: right;"> <br>
</div>
</div>
...
<form role="form" action="/builderpayment/authorizegateway/process_payment/<?=$order->id?>" method="post">
