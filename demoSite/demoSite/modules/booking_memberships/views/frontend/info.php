    ...
    <div class="row">
        <div class="col-md-12" style="padding-top:50px;">
				...
				<div class="col-md-12">
					<div class="alert alert-danger">
						...
						<div class="brand-logo">
							<img src="<?=$this->BuilderEngine->get_option('be_booking_memberships_company_logo')?>" alt="">
						</div><br/>
			...
			<div class="text-center" style="padding:50px 50px 100px 50px;">
				<a class="btn btn-lg btn-success" href="<?=base_url('booking_memberships/memberships')?>"><i class="fa fa-arrow-left"></i> Back to Memberships</a>
			</div>
        </div>
    </div>
</div>