    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">View All Membership Plans Created</h4>
            </div>
            <div class="panel-body">
				<a href="<?=base_url('admin/module/booking_memberships/add_membership')?>" class="btn btn-sm btn-success" style="margin-bottom:15px;"><i class="fa fa-plus"></i> Add New Membership Plan</a>
                <div class="table">
                    <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           <?php foreach($objects as $service):?>
                            <tr class="odd gradeX">
								<td><img src="<?=$service->image?>" class="img-responsive" style="width:80px;" /></td>
                                <td><?=stripslashes($service->name);?></td>
                                <td><?=$service->categories?></td>
								<td><?=$service->price?></td>
								<td><?=$service->capacity?></td>
								<td><?=ucfirst($service->active)?></td>
                                <td><?=date('m/d/Y',strtotime($service->start_date))?></td>
								<td><?=date('m/d/Y',strtotime($service->end_date))?></td>
								<td>
									<a href="<?=base_url()?>booking_memberships/membership/<?=$service->id?>" type="button" class="btn btn-xs btn-datatable-vertical btn-primary" target="_blank" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a>
									<a href="<?=base_url()?>admin/module/booking_memberships/modify_object/Booking_membership/<?=$service->id?>" type="button" class="btn btn-xs btn-datatable-vertical btn-success" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
									<a href="<?=base_url()?>admin/module/booking_memberships/delete_object/Booking_membership/<?=$service->id?>" type="button" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
							    </td>
                            </tr>
                          <?php endforeach;?>
                        </tbody>
