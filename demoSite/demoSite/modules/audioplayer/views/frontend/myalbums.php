            ...
            <div class="container">
                <div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<br>
						<h2 class="text-center"> My Audio Albums </h2>
						<hr>
						...
						<table class="table table-striped table-bordered">
							...
							<tbody class="audiogallery-tables-myvideos">
								...
								<tr>
									...
									<td>
										<img class="img-responsive audiogallery-table-img-photo-width" width="100" src="<?=checkImagePath($my_album->image)?>" alt="<?=str_replace('_',' ',$my_album->name)?>">
									</td>
									<td><?=$my_album->status?></td>
									<td>
										<div class="btn-group-vertical m-r-5">
											<a href="<?=base_url('audioplayer/channel/'.$user->username.'/album/'.$my_album->id)?>" class="btn btn-xs btn-primary" style="margin-bottom:3px;"><i class="fa fa-eye"></i> VIEW</a>
											...
											<a href="<?=base_url('audioplayer/delete_album/'.$my_album->id)?>" class="btn btn-xs btn-danger"><i class="fa fa-times"></i> DELETE</a>
										</div>
									</td>
								</tr>
								<?php $i++;?>
	  ...
	  <div class="modal-dialog modal-md">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="gridSystemModalLabel">Edit Album: <?=str_replace('_',' ',$my_album->name)?></h4>
		  </div>
			<form method="post" action="<?=base_url('audioplayer/edit_album/'.$my_album->id)?>" enctype="multipart/form-data">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div id="preview<?=$i?>" class="form-group" style="margin-top:43px;">
								...
								<script>
									...
									var input = "<input type=\"hidden\" name=\"image\" value=\"<?=base_url('builderengine/public/img/no_preview.png')?>\">";
								</script>
