    ...
    <div class="wrapper" style="margin-top:-20px;">
		...
		<section class="audiogallery-post-author-details gallerywhite">
			<div class="col-md-12 audio-topbargallery">
				...
				<div class="audiogallery-post-author-channel-options-margin pull-right">
					<a href="<?=base_url('audioplayer/upload')?>" class="audiogallery-btn audiogallery-btn-md audiogallery-btn-color-line"><i class="fa fa-upload left"></i>Upload Audio</a>
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu audiogallery-header-account-dropdown-box animated fadeIn">
								...
								<hr>
								<li><a href="<?=base_url('audioplayer/logout')?>"><i class="fa fa-sign-out left"></i> Log Out</a></li>
							</ul>
					</div>
        ...
        <section class="ptb">
            <div class="container">
				...
				<br>
				<h2 class="text-center"> My Audio Account Settings </h2>
				<hr>
	  ...
	  <div class="modal-dialog modal-sm">
		<div class="modal-content">
		  ...
		  <div class="modal-footer">
			...
			<a href="<?=base_url('audioplayer/delete_profile/'.$user->id.'')?>" class="btn btn-xs btn-danger"><i class="fa fa-times"></i> Delete</a>
		  </div>
		</div>
	  </div>
	</div>
