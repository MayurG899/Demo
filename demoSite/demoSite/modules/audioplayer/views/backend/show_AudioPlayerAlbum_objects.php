    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">All Audio Streaming Albums</h4>
            </div>
            <div class="panel-body">
				<form id="deleteForm" action="<?=base_url('admin/module/audioplayer/bulk_delete/AudioPlayerAlbum/show_albums')?>" method="POST">
					<a href="<?=base_url('admin/module/audioplayer/add_album')?>" class="btn btn-sm btn-success m-r-10" style="float:left"><i class="fa fa-plus"></i> Add New </a>
							...
							<tbody>
							  <?php foreach($objects as $object):?>
								<tr class="odd gradeX" data-id="<?=$object->id?>">
									<td></td>
									<td><?=$object->name;?></td>
									<td><img style="width:100px;height:80px;" src="<?=$object->image;?>"></td>
									<td><?=$object->status?></td>
									...
									<td> 
										...
										<?php $user = new User($object->user_id)?>
											<a style="margin-bottom:3px;" href="<?=base_url()?>audioplayer/channel/<?=$user->username?>/album/<?=$object->id?>" type="button" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
											<a  style="margin-bottom:3px;"  href="<?=base_url()?>admin/module/audioplayer/modify_object/AudioPlayerAlbum/<?=$object->id?>" class="btn btn-success" type="button" ><i class="fa fa-edit"></i> Edit</a>
											<a href="<?=base_url()?>admin/module/audioplayer/delete_object/AudioPlayerAlbum/<?=$object->id?>" type="button" class="btn btn-inverse"><i class="fa fa-remove"></i> Delete</a>
										</div>
									</td>
								</tr>
							  <?php endforeach;?>
