	...
	<div class="col-md-12">
		...
		<div class="alert alert-danger">
			<div class="text-center">
				<p class="lead text-center"> Only wav, mp3 and ogg file types allowed !</p><br/>
				<a href="<?=base_url('admin/module/audioplayer/add_media')?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
			</div>
		</div>
    </div>
