    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Audio Streaming Main Settings</h4>
            </div>
            <div class="panel-body panel-form">
                <form class="form-horizontal form-bordered" method="post" data-parsley-validate="true" name="demo-form">
					<div class="form-group" id="visible">
						<label class="control-label col-md-4 col-sm-4 col-be-4" for="audioplayer_active">Audio Streaming Module Active:</label>
						<div class="col-md-6 col-sm-6">
							<?php if($this->BuilderEngine->get_option('audioplayer_active') == 'yes')
						   	{
						   		$check1 = 'checked'; 
						   		$check2 = '';
						   	}
							...
							<label class="radio-inline">
                                <input type="radio" name="audioplayer_active" id="disabled" value="yes" <?=$check1?>/>
                                Yes
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="audioplayer_active" id="active" value="no" <?=$check2?>/>
                               No
                            </label>
						</div>
					</div>
					<div class="form-group" id="visible">
						<label class="control-label col-md-4 col-sm-4 col-be-4" for="audioplayer_option">User Account Options:</label>
						<div class="col-md-7 col-sm-7">
							<?php if($this->BuilderEngine->get_option('audioplayer_option') == 'open')
						   	{
						   		$check1 = 'checked'; 
						   		$check2 = '';
								$display = 'none';
							...
							?>									
							<label class="radio-inline">
                                <input type="radio" name="audioplayer_option" id="public" value="open" <?=$check1?>/>
                                Users can register and create their own channels
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="audioplayer_option" id="private" value="closed" <?=$check2?>/>
                                My Audio Player only
                            </label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<?php if($this->BuilderEngine->get_option('audioplayer_allow_ratings') == 'yes')
						   	{
						   		$check1 = 'checked'; 
						   		$check2 = '';
						   	}
							...
							?>									
							<label class="radio-inline">
                                <input type="radio" name="audioplayer_allow_ratings" value="yes" <?=$check1?>/>
                                Yes
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="audioplayer_allow_ratings" value="no" <?=$check2?>/>
                                No Ratings
                            </label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<?php if($this->BuilderEngine->get_option('audioplayer_allow_comments') == 'yes')
						   	{
						   		$check1 = 'checked'; 
						   		$check2 = '';
						   	}
							...
							?>									
							<label class="radio-inline">
                                <input type="radio" name="audioplayer_allow_comments" value="yes" <?=$check1?>/>
                                Yes
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="audioplayer_allow_comments" value="no" <?=$check2?>/>
                                No Comments
                            </label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8 col-sm-8">
							<?php if($this->BuilderEngine->get_option('audioplayer_comments_private') == 'public')
							{
						   		$check1 = 'checked'; 
						   		$check2 = '';
						   	}
							...
							?>									
							<label class="radio-inline">
                                <input type="radio" name="audioplayer_comments_private" value="public" <?=$check1?>/>
                                Everyone Can Comment (Public)
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="audioplayer_comments_private" value="private" <?=$check2?> />
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<?php if($this->BuilderEngine->get_option('audioplayer_show_tags') != 'no')
							{
								$check1 = 'checked';
								$check2 = '';
								$show = '';
							...
							?>										
							<label class="radio-inline">
                                <input type="radio" name="audioplayer_show_tags" value="yes" <?=$check1?> />
                                Yes
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="audioplayer_show_tags" value="no" <?=$check2?>/>
                                Hide Tags
                            </label>
						</div>
					</div>
					<?/*
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4" for="adminemail">Number of Tags Displayed On Audio Player Sidebar:</label>
						<div class="col-md-6 col-sm-6">
					  	    <?php $tags = $this->BuilderEngine->get_option('audioplayer_num_tags_displayed');?>
							<?php if(empty($tags))
								$tags = 0;
							?>
							<input class="form-control" type="text" name="audioplayer_num_tags_displayed" <?=$placeholder?> value="<?=$tags?>" <?=$show?>/>
						</div>
					</div>		
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4" for="adminemail">Number of Recent Sounds Displayed On Audio Player Sidebar:</label>
						<div class="col-md-6 col-sm-6">
					  	    <?php $recent_posts = $this->BuilderEngine->get_option('audioplayer_num_recent_medias_displayed');?>
							<?php if(empty($recent_posts))
								$recent_posts = 0;
							?>
							<input class="form-control" type="text" name="audioplayer_num_recent_medias_displayed" value="<?=$recent_posts?>" />
						</div>
					</div>				
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4" for="audioplayer_medias_per_page">Number of Sounds per Page:</label>
						<div class="col-md-6 col-sm-6">
							<input class="form-control" type="text" name="audioplayer_medias_per_page" value="<?=$media = $this->BuilderEngine->get_option('audioplayer_medias_per_page');?>"/>
						</div>
					</div>					
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4" for="adminemail">How Many Sounds Displayed On Main Page:</label>
						<div class="col-md-6 col-sm-6">
							<input class="form-control" type="text" name="audioplayer_num_medias_displayed" value="<?=$media = $this->BuilderEngine->get_option('audioplayer_num_medias_displayed');?>"/>
						</div>
					</div>
					*/?>
					<div class="form-group">
						...
						<div class="col-md-8 col-sm-8">
                            <ul id="access-groups">
		                      <?php $groups = explode(',', $this->BuilderEngine->get_option('audioplayer_access_groups'));?>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<input class="form-control" type="text" name="audioplayer_terms" value="<?=$this->BuilderEngine->get_option('audioplayer_terms')?>" />
						</div>
					</div>
					<div class="form-group">
						<div class="text-center">Register page additional info text:</div>
						<div class="col-md-12 col-sm-12">
							<textarea class="ckeditor" id="editor1" name="register_info" rows="10" cols="70"><?=$this->BuilderEngine->get_option("audioplayer_register_info");?></textarea>
						</div>
					</div>
					<div class="form-group">
						<div class="text-center">Login page additional info text:</div>
						<div class="col-md-12 col-sm-12">
							<textarea class="ckeditor" id="editor2" name="login_info" rows="10" cols="70"><?=$this->BuilderEngine->get_option("audioplayer_login_info");?></textarea>
						</div>
					</div>	
					<div class="form-group">
						<div class="col-md-12 col-sm-12">
