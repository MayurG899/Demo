    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Audio Streaming Comment Reports</h4>
            </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach($objects as $object):?>
                                <tr class="odd gradeX">
                                    <td><?=$i?></td>
    								<td>
                                        <?php $comment = new AudioPlayerComment($object->comment_id);?>
                                        <?=$comment->media->get()->title?>
                                    </td>
    								<td><?=date('H:i:s d/m/Y', $object->time_of_creation)?></td>
                                    <td> 
                                        <a href="<?=base_url('audioplayer/sound/'.$comment->media->get()->id)?>" target="_blank" type="button" class="btn btn-info"><i class="fa fa-info"></i> Preview Audio</a>
                                    </td>
                                    <td> 
                                        <?=$comment->text?>
                                    </td>
    								...
    								<td> 
    							        <div class="btn-group-vertical">
    						               <a href="<?=base_url('admin/module/audioplayer/delete_comment/'.$object->comment_id)?>" class="btn btn-danger" type="button" ><i class="fa fa-edit"></i> Delete Comment</a>
    						            </div>
    						            <div class="btn-group-vertical m-r-5">
    						               <a href="<?=base_url('admin/module/audioplayer/delete_report/'.$object->id)?>" type="button" class="btn btn-inverse"><i class="fa fa-remove"></i> Delete Report</a>
    						            </div>
    								</td>
                                </tr>
                                <?php $i++;?>
