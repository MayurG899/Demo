    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">View All Forum Areas</h4>
            </div>
            <div class="panel-body">
				<form id="deleteForm" action="<?=base_url('admin/module/forum/bulk_delete/Area/show_area')?>" method="POST">
					<a href="<?=base_url('admin/module/forum/add_area')?>" class="btn btn-sm btn-success m-r-10" style="float:left"><i class="fa fa-plus"></i> Add New Forum Area</a>
					<button type="submit" id="deleteChecked" name="bulkDelete" class="btn btn-sm btn-danger" style="display:none" ><i class="fa fa-trash"></i> Delete Area(s)</button>
					<br/><br/>
							...
							<tbody>
							  <?php foreach($objects as $object):?>
								<tr class="odd gradeX" data-id="<?=$object->id?>">
									...
									<td><img style="width:80px;height:80px;" src="<?=checkImagePath($object->image);?>"></td>
									<td><?=$object->groups_allowed?></td>
										<td> 
										<div class="btn-group-vertical m-r-5">
											<a style="margin-bottom:3px;" href="<?=base_url()?>forum/area/<?=$object->name?>" type="button" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
											<a  style="margin-bottom:3px;"  href="<?=base_url()?>admin/module/forum/modify_object/area/<?=$object->id?>" class="btn btn-success" type="button" ><i class="fa fa-edit"></i> Edit</a>
											<a href="<?=base_url()?>admin/module/forum/delete_area/area/<?=$object->id?>/inplace" type="button" class="btn btn-inverse"><i class="fa fa-remove"></i> Delete</a>
										</div>
										</td>
								</tr>
							  <?php endforeach;?>
