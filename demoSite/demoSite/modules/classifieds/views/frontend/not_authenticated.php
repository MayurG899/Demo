	...
	<div class="container classifieds">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">  
            <ol class="breadcrumb">
				...
				<li class="active" style="pointer-events: none"><a href="#">Account Activation Required</a></li>
            </ol>
        </div>
...
<div class="container classifieds">
    ...
    <div class="row">
        ...
        <p class="label label-danger" style="text-align: center;font-size: 100%;">Your account has not yet been validated and you can't access this page.</p>
        <h4 style="text-align: center; margin-bottom: 20px">In order to finish your account creation process you must use the link that was sent to your email address.</h4>
