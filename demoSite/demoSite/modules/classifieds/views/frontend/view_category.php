        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">  
            <ol class="breadcrumb">
                ...
                <?if(isset($parent_category)):?>
                  ...
                  <?endif;?>
                <?endif;?>
				<li class="active" style="pointer-events: none"><a href="#"><?=$category->name?></a></li>
            </ol>
        </div>
...
<div class="container classifieds">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 pull-right listings">
            <div class="search-result-top-bar"><?=$items->result_count()?> Ad<?if($items->result_count() > 1) echo 's';?> Found in <?=$category->name?></div>
