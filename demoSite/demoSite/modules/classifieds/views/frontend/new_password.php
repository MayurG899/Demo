	...
	<div class="container classifieds">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">  
            <ol class="breadcrumb">
				...
				<li class="active" style="pointer-events: none"><a href="#">Reset Password</a></li>
            </ol>
        </div>
...
<div class="container classifieds">
    ...
    <div class="row" style="margin-bottom: 550px">
        ...
        <p class="label label-danger" style="text-align: center;font-size: 100%;"> To reset your password please check your email.</p>
        <h4 style="text-align: center; margin-bottom: 20px">A password reset token has been sent to the email address you have provided in your profile.</h4>
