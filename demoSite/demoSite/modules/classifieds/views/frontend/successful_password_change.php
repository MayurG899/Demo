	...
	<div class="container classifieds">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">  
            <ol class="breadcrumb">
				...
				<li class="active" style="pointer-events: none"><a href="#">Password Change Successful</a></li>
            </ol>
        </div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 classifieds-category-activename"> 
			<h2>Password Success</h2>
        </div>
...
<div class="container classifieds">
    ...
    <div class="row" style="margin-bottom: 550px">
       ...
       <p class="label label-success" style="text-align: center;font-size: 100%;">You have successfully changed your password. You may now login.</p>
        <h4 style="text-align: center; margin-bottom: 20px">You have completed the password reset procedure and may now login.</h4>
