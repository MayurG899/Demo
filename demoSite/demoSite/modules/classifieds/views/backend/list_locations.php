    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">View All Classified Locations</h4>
            </div>
            <div class="panel-body">
				<form id="deleteForm" action="<?=base_url('admin/module/classifieds/bulk_delete/ClassifiedsLocation/list_locations')?>" method="POST">
					<a href="<?=base_url('admin/module/classifieds/add_location')?>" class="btn btn-sm btn-success m-r-10" style="float:left"><i class="fa fa-plus"></i> Add New Classified Location</a>
					<button type="submit" id="deleteChecked" name="bulkDelete" class="btn btn-sm btn-danger" style="display:none" ><i class="fa fa-trash"></i> Delete Location(s)</button>
					<br/><br/>
						...
						<table id="data-table-checkbox" class="table table-striped table-bordered table-hover"> 
							...
							<?foreach($locations->get() as $location): ?>
								<tr data-id="<?=$location->id?>">
									...
									<td><?=$i?></td>
									<td><?=$location->name?></td>
									<td><?=$location->region->get()->name?></td>
									<td>
										<div class="btn-group-vertical" style="margin-bottom:3px;">
										   <a href="<?=base_url()?>index.php/admin/module/classifieds/edit_location/<?=$location->id?>" class="btn btn-success" type="button" ><i class="fa fa-edit"></i> Edit</a>
										</div>
										<div class="btn-group-vertical m-r-5">
										   <a href="<?=base_url()?>index.php/admin/module/classifieds/delete_location/<?=$location->id?>" type="button" class="btn btn-inverse" onclick="return confirm('Are you sure you want to permanently delete this location?')"><i class="fa fa-remove"></i> Delete</a>
										</div>
									</td>
								</tr>
							<?$i++;?>
