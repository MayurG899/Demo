                ...
                <form class="form-horizontal form-bordered" data-parsley-validate="true" method="post" enctype="multipart/form-data" name="post">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" name="name" value="<?=$this->BuilderEngine->get_option('be_classifieds_company_name')?>" class="required form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <span class="btn btn-success fileinput-button">
                                ...
                                <span>Add image...</span>
                                <input id="f" type="file" name="logo" rel="file_manager" file_value="<?=checkImagePath($this->BuilderEngine->get_option('be_classifieds_company_logo'))?>">
                            </span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" name="address" value="<?=$this->BuilderEngine->get_option('be_classifieds_company_address')?>" class="required form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Company Zip</label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" name="zip" value="<?=$this->BuilderEngine->get_option('be_classifieds_company_zip')?>" class="required form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Company City</label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" name="city" value="<?=$this->BuilderEngine->get_option('be_classifieds_company_city')?>" class="required form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Company Country:</label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" name="country" value="<?=$this->BuilderEngine->get_option('be_classifieds_company_country')?>" class="required form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Company Phone:</label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" name="phone" value="<?=$this->BuilderEngine->get_option('be_classifieds_company_phone')?>" class="required form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Company Email:</label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" name="email" value="<?=$this->BuilderEngine->get_option('be_classifieds_company_email')?>" class="required form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Company TAX/VAT Number:</label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" name="tax_vat_number" value="<?=$this->BuilderEngine->get_option('be_classifieds_company_tax_vat_number')?>" class="required form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Company Bank Account Number:</label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" name="bank_account_number" value="<?=$this->BuilderEngine->get_option('be_classifieds_company_bank_account_number')?>" class="required form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Due Date/Payment Option:</label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" name="payment_option" value="<?=$this->BuilderEngine->get_option('be_classifieds_company_payment_option')?>" placeholder="for example: 30 Days, Proforma Invoice ..." class="required form-control">
                        </div>
                    </div>
                    <div class="form-group">
