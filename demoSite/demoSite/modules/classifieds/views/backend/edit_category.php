    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Edit Classified Category</h4>
            </div>
			<div class="panel-body panel-form">
				<form id="edit_category" class="form-horizontal form-bordered" data-parsley-validate="true" method="post" enctype="multipart/form-data" name="category">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 col-be-4" for="name">
					...
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 col-be-4" for="parent">
							<i class="fa fa-question-circle" style="font-size:16px;" data-toggle="tooltip" data-placement="top" title="Parent category"></i>
							Parent Category:
						</label>
						<div class="col-md-8 col-sm-8">
							<select class="form-control" name="parent" id="parent">
								...
								<? foreach ($categories as $parent):?>
									...
									<option value="<?=$parent->id?>" <? if ($parent->id == $category->parent) echo 'selected'?>><?=$parent->name?></option>
									<?endif;?>
								<? endforeach;?>
							</select>
						</div>
					...
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 col-be-4" for="image">
						...
						<div class="col-md-6 col-sm-6">
							<span class="btn btn-success fileinput-button">
								...
								<input id="f" type="file" name="image" rel="file_manager"  file_value="<?=checkImagePath($category->image)?>">
							</span>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 col-be-4" for="image2">
							<i class="fa fa-question-circle" style="font-size:16px;" data-toggle="tooltip" data-placement="top" title="Second Category Image"></i>
							Image 2
						</label>
						<div class="col-md-6 col-sm-6">
							<span class="btn btn-success fileinput-button">
								...
								<input id="f2" type="file" name="image2" rel="file_manager"  file_value="<?=checkImagePath($category->image2)?>">
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<button id="submit" type="submit" class="btn btn-primary"><i class="fa fa-check"></i> Save Category Details</button>
						</div>
					</div>
				</form>
