    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Add Classified Category</h4>
            </div>
			<div class="panel-body panel-form">
				<form id="add_category" class="form-horizontal form-bordered" data-parsley-validate="true" method="post" enctype="multipart/form-data" name="category">
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<span class="btn btn-success fileinput-button">
								...
								<input id="f" type="file" name="image" rel="file_manager">
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<span class="btn btn-success fileinput-button">
								...
								<input id="f2" type="file" name="image2" rel="file_manager">
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<button id="submit" type="submit" class="btn btn-primary"><i class="fa fa-check"></i> Add Category</button>
						</div>
					</div>
				</form>
			</div>
