    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Classified Ad Comments Reports</h4>
            </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach($objects as $object):?>
                                <tr class="odd gradeX">
    								...
    								<td>
                                        <?php 
											$comment = new ClassifiedsReview($object->review_id);
											if($comment->exists()){
												$text = $comment->conent;
											}else{
												$text = '<span class="label label-warning animated flash infinite" style="animation-duration:1.5s;">Comment Deleted</span>';
											}
											echo $text;
										?>
                                    </td>
                                    ...
                                    <td> 
                                        <a href="<?=base_url('classifieds/view_item/'.$comment->item_id)?>" target="_blank" type="button" class="btn btn-info"><i class="fa fa-info"></i> Preview Item</a>
                                    </td>
									<td>
										<?=$object->text?>
									</td>
    								<td> 
    							        <div class="btn-group-vertical">
											<?if($comment->exists()):?>
												<a href="<?=base_url('admin/module/classifieds/delete_comment/'.$object->review_id)?>" class="btn btn-danger" type="button" ><i class="fa fa-edit"></i> Delete Comment</a>
											<?endif;?>
    						            </div>
    						            <div class="btn-group-vertical m-r-5">
    						               <a href="<?=base_url('admin/module/classifieds/delete_comment_report/'.$object->id)?>" type="button" class="btn btn-inverse"><i class="fa fa-remove"></i> Delete Report</a>
    						            </div>
    								</td>
                                </tr>
                                <?php $i++;?>
