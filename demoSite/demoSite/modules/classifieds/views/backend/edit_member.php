    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Edit Classified Member Account</h4>
            </div>
			<div class="panel-body panel-form">
                <form class="form-horizontal form-bordered" method="post">
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-be-4" for="required">Username</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="username" class="form-control" value="<?=$member->username?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-be-4" for="required">First Name</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="first_name" class="form-control" value="<?=$member->first_name?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-be-4" for="required">Last Name</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="last_name" class="form-control" value="<?=$member->last_name?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-be-4" for="required">Email</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="email" name="email" class="form-control" value="<?=$member->email?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-be-4" for="required">Date registered</label>
                        <div class="col-md-8 col-sm-8">
                            <p style="margin-bottom:0px; margin-top:7px"><?=date('H:i:s d/m/Y', $member->date_registered)?></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-be-4" for="required">Telephone</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="telephone" class="form-control" value="<?=$member->classifiedsmemberextend->get()->telephone?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-be-4" for="required">Address</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="address" class="form-control" value="<?=$member->classifiedsmemberextend->get()->address?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-be-4" for="required">City</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="city" class="form-control" value="<?=$member->classifiedsmemberextend->get()->city?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-be-4" for="required">State</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="state" class="form-control" value="<?=$member->classifiedsmemberextend->get()->state?>" required>
                        </div>
                    </div> 					
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-be-4" for="required">Country</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="country" class="form-control" value="<?=$member->classifiedsmemberextend->get()->country?>" required>
                        </div>
                    </div>              
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 col-be-4"></label>
						<div class="col-md-6 col-sm-6">
							<button id="submit" type="submit" class="btn btn-primary"><i class="fa fa-check"></i> Save Member Details</button>
						</div>
					</div>
                </form>
