    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">View All Classified Categories</h4>
            </div>
            <div class="panel-body">
				<form id="deleteForm" action="<?=base_url('admin/module/classifieds/bulk_delete/ClassifiedsCategory/list_categories')?>" method="POST">
					<a href="<?=base_url('admin/module/classifieds/add_category')?>" class="btn btn-sm btn-success m-r-10" style="float:left"><i class="fa fa-plus"></i> Add New </a>
						...
						<table id="data-table-checkbox" class="table table-striped table-bordered table-hover">
							...
							<?foreach($categories as $category): ?>
								<tr data-id="<?=$category->id?>">
									<td></td>
									<td><?=$category->name?></td>
									<td><? $category_parent = new ClassifiedsCategory($category->parent); if($category_parent->exists()) echo $category_parent->name; else echo 'No Parent';?></td>
									<td>
										<div class="" style="margin-bottom:3px;">
											<a href="<?=base_url()?>classifieds/view_category/<?=$category->id?>" class="btn btn-sm btn-primary" type="button" ><i class="fa fa-eye"></i> View</a>
										   <a href="<?=base_url()?>index.php/admin/module/classifieds/edit_category/<?=$category->id?>" class="btn btn-sm btn-success" type="button" ><i class="fa fa-edit"></i> Edit</a>
										   <?/*<a href="<?=base_url()?>index.php/admin/module/classifieds/delete_category/<?=$category->id?>" type="button" class="btn btn-inverse" onclick="return confirm('Are you sure you want to permanently delete this category? All items linked to this category will remain intact, but will lose connection to this category.')"><i class="fa fa-remove"></i> Delete</a>*/?>
										</div>
									</td>
								</tr>
							<?$i++;?>
