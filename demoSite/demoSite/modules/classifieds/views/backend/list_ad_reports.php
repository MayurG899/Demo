    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Classified Ad Reports From Users</h4>
            </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach($objects as $object):?>
                                <tr class="odd gradeX">
                                    <td><?=$i?></td>
    								<td>
                                        <?php $item = new ClassifiedsItem($object->item_id);?>
                                        <?=$item->name?>
                                    </td>
    								<td><?=date('H:i:s d/m/Y', $object->time_of_creation)?></td>
                                    <td> 
                                        <a href="<?=base_url('classifieds/view_item/'.$object->item_id)?>" target="_blank" type="button" class="btn btn-info"><i class="fa fa-info"></i> Preview Item</a>
                                    </td>
									<td>
										<?=$object->text?>
									</td>
    								<td> 
    							        <div class="btn-group-vertical">
    						               <a href="<?=base_url('admin/module/classifieds/delete_item/'.$object->item_id)?>" class="btn btn-danger" type="button" ><i class="fa fa-edit"></i> Delete Item</a>
    						            </div>
    						            <div class="btn-group-vertical m-r-5">
    						               <a href="<?=base_url('admin/module/classifieds/delete_ad_report/'.$object->id)?>" type="button" class="btn btn-inverse"><i class="fa fa-remove"></i> Delete Report</a>
    						            </div>
    								</td>
                                </tr>
                                <?php $i++;?>
