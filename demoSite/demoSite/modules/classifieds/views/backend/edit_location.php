    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Edit Classified Location</h4>
            </div>
			<div class="panel-body panel-form">
				<form class="form-horizontal form-bordered" method="post">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 col-be-4" for="required">Location Name:</label>
						<div class="col-md-8 col-sm-8">
							<input type="text" name="name" class="form-control" value="<?=$location->name?>" required>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 col-be-4" for="required">Region Attached To:</label>
						<div class="col-md-8 col-sm-8">
							<select name="region_id" required class="form-control">
								<?foreach($regions->get() as $region):?>
									<option value="<?=$region->id?>" <?if($location->region->get()->id == $region->id) echo 'selected';?>><?=$region->name?></option>
								<?endforeach;?>
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<button id="submit" type="submit" class="btn btn-primary"><i class="fa fa-check"></i> Save Location Details</button>
						</div>
					</div>
				</form>
