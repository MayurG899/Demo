    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">View All Classified Regions</h4>
            </div>
            <div class="panel-body">
				<form id="deleteForm" action="<?=base_url('admin/module/classifieds/bulk_delete/ClassifiedsRegion/list_regions')?>" method="POST">
					<a href="<?=base_url('admin/module/classifieds/add_region')?>" class="btn btn-sm btn-success m-r-10" style="float:left"> <i class="fa fa-plus"></i> Add New Classified Regions</a>
					<button type="submit" id="deleteChecked" name="bulkDelete" class="btn btn-sm btn-danger" style="display:none" ><i class="fa fa-trash"></i> Delete Region(s)</button>
					<br/><br/>
								...
								<tr data-id="<?=$region->id?>">
									...
									<td>
										<div class="btn-group-vertical" style="margin-bottom:3px;">
										   <a href="<?=base_url()?>index.php/admin/module/classifieds/edit_region/<?=$region->id?>" class="btn btn-success" type="button" ><i class="fa fa-edit"></i> Edit</a>
										</div>
										<div class="btn-group-vertical m-r-5">
										   <a href="<?=base_url()?>index.php/admin/module/classifieds/delete_region/<?=$region->id?>" type="button" class="btn btn-inverse" onclick="return confirm('Are you sure you want to permanently delete this region? All locations linked to this region will remain intact, but will lose connection to this region.')"><i class="fa fa-remove"></i> Delete</a>
										</div>									
									</td>
								</tr>
							<?$i++;?>
