    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Edit Classified Ad</h4>
            </div>
			<div class="panel-body panel-form">
                <form class="form-horizontal form-bordered" method="post">
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Ad Name</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="name" class="form-control" value="<?=$item->name?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Ad Price</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="price" class="form-control" value="<?=$item->price?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Date of creation</label>
                        <div class="col-md-8 col-sm-8">
                            <p style="margin-bottom:0px; margin-top:7px"><?=date('H:i:s d/m/Y', $item->time_of_creation)?></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Ad Views</label>
                        <div class="col-md-8 col-sm-8">
                            <p style="margin-bottom:0px; margin-top:7px"><?=$item->views?></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Ad Description</label>
                        <div class="col-md-8 col-sm-8">
                            <textarea name="description" class="form-control"><?=$item->description?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Telephone</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="phone" class="form-control" value="<?=$item->telephone?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Email</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="email" name="email" class="form-control" value="<?=$item->email?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Country</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="country" class="form-control" value="<?=$item->country?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">State</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="state" class="form-control" value="<?=$item->state?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">City</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="city" class="form-control" value="<?=$item->city?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="required">Address</label>
                        <div class="col-md-8 col-sm-8">
                            <input type="text" name="address" class="form-control" value="<?=$item->address?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="tags">Classified Category</label>
                        <div class="col-md-8 col-sm-8">
                            <select name="category_id" id="parent"  class="form-control" required>
                                <option value="0">-- Select Category --</option>
                                <? foreach ($categories as $category):?>
                                    <option value="<?=$category->id?>" <?if($item->category_id == $category->id) echo 'selected';?>><?=$category->name?></option>
                                <? endforeach;?> 
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="tags">Currency</label>
                        <div class="col-md-8 col-sm-8">
                            <select name="currency_id" id="parent"  class="form-control" required>
                                <option value="0">-- Select Category --</option>
                                <? foreach ($currencies as $currency):?>
                                    <option value="<?=$currency->id?>" <?if($item->currency_id == $currency->id) echo 'selected';?>><?=$currency->symbol?></option>
                                <? endforeach;?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-be-3" for="tags">Sold</label>
                        <div class="col-md-8 col-sm-8">
                            <select name="sold" id="parent" class="form-control">
                                <option value="no" <?if($item->sold == 'no') echo 'selected';?>>No</option>
                                <option value="yes" <?if($item->sold == 'yes') echo 'selected';?>>Yes</option>
                            </select>
                        </div>
                    </div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<button id="submit" type="submit" class="btn btn-primary"><i class="fa fa-check"></i> Save Classified Ad</button>
						</div>
					</div>
                </form>
