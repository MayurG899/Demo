    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">View All Active Classified Members</h4>
            </div>
                ...
                <div class="table-responsive">
                    <table id="data-table" class="table table-striped table-bordered table-hover"> 
						...
						<?foreach($members->get() as $member): ?>
							<?
								$e = new UserExtended();
								$extended = $e->where('user_id',$member->id)->get();
							?>
							<tr>
								<td><?=$member->id?></td>
								...
								<td><?=$member->email?></td>
								<td><?=date('d-m-Y',$member->date_registered)?></td>
								<td><?=$extended->telephone?></td>
								<td><?=$extended->country?></td>
								<td><?=$extended->city?></td>
								<td style="text-align: center">
									<?$ce = new ClassifiedsMemberExtend();
										$memberextend = $ce->where('member_id',$member->id)->get();
									?>
									<?if($memberextend->registration_completed == 'yes'):?>
										<a class="btn btn-danger" style="width:100%" href="<?=base_url();?>index.php/admin/module/classifieds/toggle_active_member/<?=$member->id?>">Deactivate</a>
									<?else:?>
										<a class="btn btn-success" style="width:100%" href="<?=base_url();?>index.php/admin/module/classifieds/toggle_active_member/<?=$member->id?>">Activate</a>
									<?endif;?>
								</td>
								<?/*
								<td>
									<div class="btn-group-vertical" style="margin-bottom:3px;">
									   <a href="<?=base_url();?>index.php/admin/module/classifieds/edit_member/<?=$member->id?>" class="btn btn-success" type="button" ><i class="fa fa-edit"></i> Edit</a>
									</div>
								</td>
								*/?>
							</tr>
