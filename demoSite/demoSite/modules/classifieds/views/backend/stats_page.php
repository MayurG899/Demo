    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Classified Statistics</h4>
            </div>
            <div class="panel-body panel-form">
                <form class="form-horizontal form-bordered" method="post">
                    <div class="form-group">
						<label class="control-label col-md-4 col-sm-4" for="products_per_page">Total number of ads posted:</label>
                        <div class="col-md-8 col-sm-8">
                            <span class="label label-success" style="font-weight: bold;margin-left: 3%;font-size: 18px"><?
                            $items = new ClassifiedsItem();
                            echo $items->get()->result_count();
                            ?></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4" for="required">Total number of ads sold:</label>
                        <div class="col-md-8 col-sm-8">
                            <span class="label label-success"style="font-weight: bold;margin-left: 3%;font-size: 18px"><?
                            $sold_items = new ClassifiedsItem();
                            echo $sold_items->where('sold', 'yes')->get()->result_count();
                            ?></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4" for="required">Total number of users:</label>
                        <div class="col-md-8 col-sm-8">
                            <span class="label label-success" style="font-weight: bold;margin-left: 3%;font-size: 18px"><?
                            $members = new ClassifiedsMember();
                            echo $members->get()->result_count();
                            ?></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4" for="required">Total number of sellers:</label>
                        <div class="col-md-8 col-sm-8">
                            <span class="label label-success" style="font-weight: bold;margin-left: 3%;font-size: 18px"><?
								$sellers = new ClassifiedsMember();
								$posted_items = new ClassifiedsItem();
								$count = 0;
								foreach($sellers->get() as $seller)
								{
									foreach($posted_items->get() as $posted_item)
									{
										if($posted_item->posting_member_id == $seller->id)
											$count++;
									}
								}
								echo $count;
