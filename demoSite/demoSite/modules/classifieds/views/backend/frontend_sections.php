    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Classified Frontend Sections</h4>
            </div>
            <div class="panel-body panel-form">
                    <form id="edit_category" class="form-horizontal form-bordered" method="post">
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4" for="required">Subcategories</label>
                            <div class="col-md-8 col-sm-8">
                                <select name="subcategories" class="form-control">
                                    <option value="hidden" <?if($this->BuilderEngine->get_option('be_classifieds_frontend_sections_subcategories') == 'hidden') echo 'selected';?>>Hidden</option>
                                    <option value="visible" <?if($this->BuilderEngine->get_option('be_classifieds_frontend_sections_subcategories') == 'visible') echo 'selected';?>>Visible</option>
                                </select>
                            </div>
                        </div><!-- End .control-group  -->
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4" for="required">Top Search Bar</label>
                            <div class="col-md-8 col-sm-8">
                                <select name="top_search" class="form-control">
                                    <option value="hidden" <?if($this->BuilderEngine->get_option('be_classifieds_frontend_sections_top_search') == 'hidden') echo 'selected';?>>Hidden</option>
                                    <option value="visible" <?if($this->BuilderEngine->get_option('be_classifieds_frontend_sections_top_search') == 'visible') echo 'selected';?>>Visible</option>
                                </select>
                            </div>
                        </div><!-- End .control-group  -->
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4" for="required">Header Search Bar</label>
                            <div class="col-md-8 col-sm-8">
                                <select name="header_search" class="form-control">
                                    <option value="hidden" <?if($this->BuilderEngine->get_option('be_classifieds_frontend_sections_header_search') == 'hidden') echo 'selected';?>>Hidden</option>
                                    <option value="visible" <?if($this->BuilderEngine->get_option('be_classifieds_frontend_sections_header_search') == 'visible') echo 'selected';?>>Visible</option>
                                </select>
                            </div>
                        </div><!-- End .control-group  -->
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4" for="required">Place Ad header button</label>
                            <div class="col-md-8 col-sm-8">
                                <select name="place_ad" class="form-control">
                                    <option value="hidden" <?if($this->BuilderEngine->get_option('be_classifieds_frontend_sections_place_ad') == 'hidden') echo 'selected';?>>Hidden</option>
                                    <option value="visible" <?if($this->BuilderEngine->get_option('be_classifieds_frontend_sections_place_ad') == 'visible') echo 'selected';?>>Visible</option>
                                </select>
                            </div>
                        </div><!-- End .control-group  -->
						<div class="form-group">
