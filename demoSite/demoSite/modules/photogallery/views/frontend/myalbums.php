            ...
            <div class="container">
                <div class="">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<br>
						<h2 class="text-center"> My Photo Albums </h2>
						<hr>
						...
						<table class="table table-striped table-bordered">
							...
							<tbody class="photogallery-tables-myvideos">
								...
								<tr>
									...
									<td>
										<img class="img-responsive photogallery-table-img-photo-width" width="100" src="<?=$my_album->image?>" alt="<?=$my_album->name?>">
									</td>
									<td><?=$my_album->status?></td>
									<td>
										<div class="btn-group-vertical m-r-5">
											<a href="<?=base_url('photogallery/channel/'.$user->username.'/album/'.$my_album->id)?>" class="btn btn-xs btn-primary" style="margin-bottom:3px;"><i class="fa fa-eye"></i> VIEW</a>
											...
											<a href="<?=base_url('photogallery/delete_album/'.$my_album->id)?>" class="btn btn-xs btn-danger"><i class="fa fa-times"></i> DELETE</a>
										</div>
									</td>
								</tr>
								<?php $i++;?>
	  ...
	  <div class="modal-dialog modal-md">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<form method="post" action="<?=base_url('photogallery/edit_album/'.$my_album->id)?>" enctype="multipart/form-data">
