    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">View All Photos</h4>
            </div>
            <div class="panel-body">
				<form id="deleteForm" action="<?=base_url('admin/module/photogallery/bulk_delete/PhotoGalleryMedia/show_media')?>" method="POST">
					<a href="<?=base_url('admin/module/photogallery/add_media')?>" class="btn btn-sm btn-success m-r-10" style="float:left"><i class="fa fa-plus"></i> Add New </a>
							...
							<tbody>
							   <?php foreach($objects as $object):?>
								<tr class="odd gradeX" data-id="<?=$object->id?>">
									...
									<td>
										<img src="<?=checkImagePath($object->file)?>" width="100" height="80" alt="Preview Image">
									</td>
									<td>
									...
									<td>
										<div class="btn-group-vertical m-r-5">
											<a  style="margin-bottom:3px;" href="<?=base_url()?>photogallery/photo/<?=$object->id?>" type="button" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
											<a  style="margin-bottom:3px;" href="<?=base_url()?>admin/module/photogallery/modify_object/PhotoGalleryMedia/<?=$object->id?>" type="button" class="btn btn-success"><i class="fa fa-edit"></i> Edit</a>
											<a href="<?=base_url()?>admin/module/photogallery/delete_object/PhotoGalleryMedia/<?=$object->id?>" type="button" class="btn btn-inverse"><i class="fa fa-remove"></i> Delete</a>
										</div>
									</td>
								</tr>
							  <?php endforeach;?>
