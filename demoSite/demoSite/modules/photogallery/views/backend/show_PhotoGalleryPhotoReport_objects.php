    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Photos & Member Account Reports</h4>
            </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach($objects as $object):?>
                                <tr class="odd gradeX">
                                    <td><?=$i?></td>
    								<td>
                                        <?php $video = new PhotoGalleryMedia($object->media_id);?>
                                        <?=$video->title?>
                                    </td>
    								<td><?=date('H:i:s d/m/Y', $object->time_of_creation)?></td>
                                    <td> 
                                        <a href="<?=base_url('photogallery/photo/'.$object->media_id)?>" target="_blank" type="button" class="btn btn-info"><i class="fa fa-info"></i> Preview Photo</a>
                                    </td>
									<td>
										<?=$object->text?>
									</td>
    								<td> 
    							        <div class="btn-group-vertical">
    						               <a href="<?=base_url('admin/module/photogallery/delete_photo/'.$object->media_id)?>" class="btn btn-danger" type="button" ><i class="fa fa-edit"></i> Delete Photo</a>
    						            </div>
    						            <div class="btn-group-vertical m-r-5">
    						               <a href="<?=base_url('admin/module/photogallery/delete_photo_report/'.$object->id)?>" type="button" class="btn btn-inverse"><i class="fa fa-remove"></i> Delete Report</a>
    						            </div>
    								</td>
                                </tr>
                                <?php $i++;?>
