<?php
	class PhotoGalleryComment extends DataMapper 
	{
		var $table = 'be_photo_gallery_comments';
		...
		var $has_many = array(
			'report' => array(
				'class' => 'PhotoGalleryCommentReport',
				'other_field' => 'comment',
				'join_self_as' => 'comment',
        ...
        {
            $comment_report = new PhotoGalleryCommentReport();
