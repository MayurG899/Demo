    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">View All Departments For Your Rooms / Venues</h4>
            </div>
            <div class="panel-body">
				<form id="deleteForm" action="<?=base_url('admin/module/booking_rooms/bulk_delete/BookingRoomCategory/show_room_categories')?>" method="POST">
					<a href="<?=base_url('admin/module/booking_rooms/add_room_category')?>" class="btn btn-sm btn-success m-r-10" style="float:left"><i class="fa fa-plus"></i> Add New Department</a>
					<button type="submit" id="deleteChecked" name="bulkDelete" class="btn btn-sm btn-danger" style="display:none" ><i class="fa fa-trash"></i> Delete Department(s)</button>
					<br/><br/>
					<div class="table">
						<style type="text/css">
									...
									<tr class="odd gradeX" data-id="<?=$object->id?>">
										...
										<td> 
											<div class="btn-group-vertical m-r-5">
												<a href="<?=base_url()?>booking_rooms/category/<?=$object->id?>" type="button" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
											   <a href="<?=base_url()?>admin/module/booking_rooms/modify_object/BookingRoomCategory/<?=$object->id?>" class="btn btn-success" type="button" ><i class="fa fa-edit"></i> Edit</a>
											   <a href="<?=base_url()?>admin/module/booking_rooms/delete_object/BookingRoomCategory/<?=$object->id?>" type="button" class="btn btn-inverse"><i class="fa fa-remove"></i> Delete</a>
											</div>
										</td>
									</tr>
								<?php endif;?>
