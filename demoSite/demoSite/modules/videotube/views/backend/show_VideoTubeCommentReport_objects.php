    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Video Channels Comment Reports</h4>
            </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach($objects as $object):?>
                                <tr class="odd gradeX">
                                    <td><?=$i?></td>
    								<td>
                                        <?php $comment = new VideoTubeComment($object->comment_id);?>
    								...
    								<td> 
    							        <div class="btn-group-vertical">
    						               <a href="<?=base_url('admin/module/videotube/delete_comment/'.$object->comment_id)?>" class="btn btn-danger" type="button" ><i class="fa fa-edit"></i> Delete Comment</a>
    						            </div>
    						            <div class="btn-group-vertical m-r-5">
    						               <a href="<?=base_url('admin/module/videotube/delete_report/'.$object->id)?>" type="button" class="btn btn-inverse"><i class="fa fa-remove"></i> Delete Report</a>
    						            </div>
    								</td>
                                </tr>
                                <?php $i++;?>
