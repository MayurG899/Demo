	...
	<div class="col-md-12">
		<div class="alert alert-danger">
			<div class="text-center">
				<p class="lead text-center"> Only mp4, avi, mpg and mpeg file types allowed !</p><br/>
				<a href="<?=base_url('admin/module/videotube/add_media')?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
			</div>
		</div>
    </div>
...
<!-- begin #sidebar-right -->
		<div id="sidebar-right" class="sidebar sidebar-right">
			...
			<div data-scrollbar="true" data-height="100%">
				<!-- begin sidebar user -->
				<ul class="nav m-t-10">
					<h4 class="sidebar-right-main-title">Video Streaming</h4>
					<li class="nav-widget">
                            ...
                            <div class="panel panel-grey">
                                ...
                                <div id="collapseQuide" class="panel-collapse collapse">
                                    <div class="panel-body panel-body-2">
                                        Setup your Video Streaming Website by using the module options on the left sidebar. <br><br>
							...
							<ul class="todolist">
								<li class="active">
									<a href="javascript:;" class="todolist-container active" data-click="todolist">
										...
										<div class="todolist-title">Video Streaming</div>
									</a>
								</li>
								<li>
