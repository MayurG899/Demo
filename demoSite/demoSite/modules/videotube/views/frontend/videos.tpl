...
<div class="wrapper">
	{block type='page' name="videotube-channel"}
		{block type='row' class="" name="videotube-channel-row-2"}
			...
			{/block}
		{/block}
		{block type='row' class="ptb container videochannels-row-nocontainer" name="videotube-channel-row-3"}
			{block type='column' class="col-lg-12 col-md-12 col-sm-12 col-xs-12" name="videotube-channel-row-3-col-1"}
				{block type='videotube_all_videos_thumbnails_user' name="videotube-channel-row-3-col-1-block-1"}
					{content}
					{/content}
				{/block}
			{/block}
