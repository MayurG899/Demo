    ...
    <div class="wrapper">
        ...
        <section class="ptb">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div id="uploadForm" class="dark-bg" style="width:100%;height:500px;display:none;padding-top:10px;color;#fff;border-radius:5px;">
							<?php if($num_albums > 0):?>
							<form method="post" id="fors" style="">
							<?php endif;?>
								<input id="uploadedFile" type="hidden" name="media_file" >
								...
								<label class="control-label col-md-4 col-sm-4" for="fullname">Select Album:</label>
									...
									<div class="col-md-8 col-sm-8">
										<a href="<?=base_url('videotube/add_album/first')?>" class="btn btn-md btn-white-line animated infinite flash" style="margin-bottom:15px;"><i class="fa fa-cloud left"></i>Click here to Create an Album</a>
									</div>
								<?php endif;?>
								</div>							
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="fullname">Video Title:</label>
									<div class="col-md-8 col-sm-8">
								...
								<div class="form-group">
								   ...
								   <label class="control-label col-md-4 col-sm-4" for="status">Video Status:</label>
									<div class="col-md-8 col-sm-8">
