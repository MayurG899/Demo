...
// To be updated
 class Block{
    ...
    public function generate_admin($menu = '', $active_menu = '')
    {
        if(true /*$this->type != 'generic'*/)
        {
            ...
            if($menu == 'styler')
                if($active_menu != '')
                    return $handler->generate_styles($active_menu);
                else
                    return $handler->generate_styles();
            else
...
//        }
    ...
    public function get_initial_settings()
    {
        ...
        $handler = new $classname();
        $handler->set_block($this);
        return $handler->set_initial_values_if_empty();
    }
    // edit end
    public function show()
    {
        ...
        $block_content = "<div class='block-content'
        id='block-content-id-{$this->name}'
        block-type='{$this->type}'";
        if($block_editor != 'ckeditor')
            $block_content .= "block-editor='{$block_editor}'";
        $block_content .= "
        ...
        {
            case "header":
                $this->html .= '<div class="block-controls be-simple-editor-header-controls section-block-'.$this->id.'">
                                    <div class="block-controls-inner panel-heading-btn">
                                        <p class="new-block-clarification" style="margin-left: 45% !important;">Right-click for options</p>
										<a rel="tooltip" data-placement="top" title="Remove" href="#close" class="remove btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
										<a rel="tooltip" data-placement="top" title="Hide Block" class="collapse-element btn btn-xs btn-warning be-simple-editor-header-minus"><i class="fa fa-minus"></i></a>
										<a rel="tooltip" data-placement="top" title="Add Block" href="#" onclick="window.top.openPushMenu('.$this->id.');" class="btn btn-xs btn-indigo " id="trigger-'.$this->id.'"><i class="fa fa-plus"></i></a>
                                        ';
                ...
                break;
            case "page":
                $this->html .= '<div class="block-controls be-simple-editor-page-controls section-block-'.$this->id.'">
                                   <div class="block-controls-inner panel-heading-btn">
                                        <p class="new-block-clarification" style="margin-left: 45% !important;">Right-click for options</p>
										<a rel="tooltip" data-placement="top" title="Remove" href="#close" class="remove btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
										<a rel="tooltip" data-placement="top" title="Hide Block" class="collapse-element btn btn-xs btn-warning be-simple-editor-page-minus"><i class="fa fa-minus"></i></a>
										<a rel="tooltip" data-placement="top" title="Add Block" href="#" onclick="window.top.openPushMenu('.$this->id.');" class="btn btn-xs btn-indigo " id="trigger-'.$this->id.'"><i class="fa fa-plus"></i></a>
                                        ';
                $this->html .= $this->output_admin_options();
                $this->html .= "   </div>
                                </div>";
                $classes .= " be-page-content-block be-page-block be-container-block";
                $this->children_holder_classes = " page-children ";
                break;

            case "footer":
                $this->html .= '<div class="block-controls be-simple-editor-footer-controls section-block-'.$this->id.'">
                                    <div class="block-controls-inner panel-heading-btn">
                                        <p class="new-block-clarification" style="margin-left: 45% !important;">Right-click for options</p>
										<a rel="tooltip" data-placement="top" title="Remove" href="#close" class="remove btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
										<a rel="tooltip" data-placement="top" title="Hide Block" class="collapse-element btn btn-xs btn-warning be-simple-editor-footer-minus"><i class="fa fa-minus"></i></a>
										<a rel="tooltip" data-placement="top" title="Add Block" href="#" onclick="window.top.openPushMenu('.$this->id.');" class="btn btn-xs btn-indigo " id="trigger-'.$this->id.'"><i class="fa fa-plus"></i></a>
                                        ';
                $this->html .= $this->output_admin_options();
                $this->html .= "   </div>
                                </div>";
                $classes .= " be-footer-content-block be-footer-block be-container-block";
				$this->children_holder_classes = " row-children ";
                break;
            case "row":
                $this->html .= '<div class="block-controls be-simple-editor-row-controls section-block-'.$this->id.'">
                                    <div class="block-controls-inner panel-heading-btn">
                                       <p class="new-block-clarification" style="margin-left: 45% !important;">Right-click for options</p>
            ...
            case "column":
                ...
                $this->html .= '<div class="block-controls section-block-'.$this->id.'">
                                    <div class="block-controls-inner panel-heading-btn">

                                       <p class="new-block-clarification" style="margin-left: 45% !important;">Right-click for options</p>
                                       <a rel="tooltip" data-placement="top" title="Remove" href="#close" class="remove btn btn-xs btn-danger be-simple-editor-column-delete"><i class="fa fa-times"></i></a>
						
										<a rel="tooltip" data-placement="top" title="Add Block" href="#" onclick="window.top.openPushMenu('.$this->id.');" class="btn btn-xs btn-indigo hide-add-block" id="trigger-'.$this->id.'"><i class="fa fa-plus"></i></a>
                                    ';
                $this->html .= $this->output_admin_options();
                $this->html .= '
                                    </div>
            ...
            case "generic":
                ...
                $classes = " be-content-block generic-block-".$this->id;
                $this->html .= '<div class="block-controls blockOverLay drag">
									<div class="be-simple-editor-generic-controls">
										<div class="block-controls-inner panel-heading-btn">
											...
											<a rel="tooltip" data-placement="top" title="Add Block" href="#" onclick="window.top.openPushMenu('.$this->id.');" class="btn btn-xs btn-indigo be-simple-editor-addblock-generic" id="trigger-'.$this->id.'"><i class="fa fa-plus"></i></a>
											
											<a rel="tooltip" data-placement="top" title="Undo FreeMove" href="#undo" class="undo btn btn-xs btn-white be-simple-editor-undo"><i class="fa fa-undo"></i></a>
											
											<a rel="tooltip" data-placement="top" title="Edit Content" href="#" class="btn btn-xs btn-success be-simple-editor-edit-generic" id="blockEdit-'.$this->id.'"><i class="fa fa-edit"></i></a>
										</div>
									</div>
            ...
            case "content":
                ...
                echo '
                    ...
                    {
                        content: "'.ucfirst(str_replace('_', ' ', $this->type)).' Block"; 
                    }
                    </style>
                ';
                $classes = $block_type_class.' '.$block_type_html_class;
                $this->html .= '<div class="block-controls be-simple-editor-content-controls section-block-'.$this->id.'">
                                    <div class="block-controls-inner panel-heading-btn">
                                        <p class="new-block-clarification" style="margin-left: 45% !important;">Right-click for options</p>

                                        <a rel="tooltip" data-placement="top" title="Remove" href="#close" class="remove btn btn-xs btn-danger"><i class="fa fa-times"></i></a>

                                        <a rel="tooltip" data-placement="top" title="Hide Block" class="collapse-element btn btn-xs btn-warning be-simple-editor-content-minus" data-click="panel-collapse" data-original-title="" title=""><i class="fa fa-minus"></i></a>
            ...
            case "container":
                ...
                ';
                $classes = $block_type_class.' '.$block_type_html_class;
                $this->html .= '<div class="block-controls be-simple-editor-container-controls section-block-'.$this->id.'">
                                    <div class="block-controls-inner panel-heading-btn">
                                        <p class="new-block-clarification" style="margin-left: 45% !important;">Right-click for options</p>

                                        <a rel="tooltip" data-placement="top" title="Remove" href="#close" class="remove btn btn-xs btn-danger"><i class="fa fa-times"></i></a>

                                        <a rel="tooltip" data-placement="top" title="Hide Block" class="collapse-element btn btn-xs  btn-warning be-simple-editor-container-minus" data-click="panel-collapse" data-original-title="" title=""><i class="fa fa-minus"></i></a>
            ...
            default:
                ...
                ';
                $classes = $block_type_class.' '.$block_type_html_class;
                $this->html .= '<div class="be-hovercontainer-block section-block-'.$this->id.'">
                                    <div class="block-controls blockOverLay drag">
									<div class="be-simple-editor-block-controls">
									<div class="block-controls-inner panel-heading-btn">
                                        <p class="new-block-clarification" style="margin-left: 45% !important;">Right-click on block content for options</p>

                                        <a rel="tooltip" data-placement="top" title="Remove" href="#close" class="remove btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
										
										<a rel="tooltip" data-placement="top" title="Add Block" href="#" onclick="window.top.openPushMenu('.$this->id.');" class="btn btn-xs btn-indigo be-simple-editor-addblock-generic" id="trigger-'.$this->id.'"><i class="fa fa-plus"></i></a>';
										if($this->data('editorEnabled') != NULL){
											$this->html .= '<a rel="tooltip" data-placement="top" title="Edit Content" href="#" class="btn btn-xs btn-success be-simple-editor-edit-generic" id="blockEdit-'.$this->id.'"><i class="fa fa-edit"></i></a>';
										}
										else
										{
											if($this->data('editorAndSettingsEnabled') != NULL){
												$this->html .= 
													'<a rel="tooltip" data-placement="top" title="Edit Content" href="#" class="btn btn-xs btn-success be-simple-editor-edit-generic" id="blockEdit-'.$this->id.'"><i class="fa fa-edit"></i></a>';
											}
										}
                                        $this->html .= '
                                        <a rel="tooltip" data-placement="top" title="Undo FreeMove" href="#undo" class="undo btn btn-xs btn-white be-simple-editor-undo"><i class="fa fa-undo"></i></a>
										<a rel="tooltip" data-placement="top" title="Settings" href="#" class="btn btn-xs btn-success " id="blockSettings-'.$this->id.'"><i class="fa fa-cogs"></i></a>';
    ...
    public function has_class_css($class)
    {
        $style = $this->data('style');
        if(!$style)
            return false;
    ...
    {
        return $this->data('css_classes').' '.$this->data('custom_classes');
    }
