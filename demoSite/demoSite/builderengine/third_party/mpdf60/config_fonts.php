...
# Following Fonts require their font files to be uploaded to /ttfonts , also some related files has been removed from /ttfontdata , /iccprofiles (removed 2 files)
/*
	"dejavusans" => array(
		'R' => "DejaVuSans.ttf",
