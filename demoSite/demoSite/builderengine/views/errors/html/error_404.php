...
<body id="not-found-alt">
  ...
  <div class="info">
    ...
    <p class="go-back">
      ...
      <!-- Please return to our <a class="btn btn-lg btn-primary" href="/index.php">Home page</a>.-->
	  <?if(isset($_SERVER['HTTP_REFERER'])):?>
		<a class="btn btn-lg btn-primary" href="<?=$_SERVER['HTTP_REFERER']?>" style="color:#fff"> Go Back </a>
	<?else:?>
		<a class="btn btn-lg btn-primary" href="/" style="color:#fff"> Home </a>
	<?endif;?>
