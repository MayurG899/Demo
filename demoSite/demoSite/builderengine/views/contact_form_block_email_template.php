<?php
	...
	foreach ($fields as $field_name => $field_value)
	{
		if($field_value == '')
			$field_value = '[empty]';
			$message = str_replace('_', ' ', ucwords($field_name)). ": ".$field_value;
			$p[$count] = $message;
		$count++;
	}
?>
...
<body style="background:url(<?=base_url('blocks/contact_form/paper.jpg')?>);border:3px solid #000;">
	<table class="body">
		<tr>
			<td class="center" align="center" valign="top">
				<center>
					...
					<table class="container">
						<tr>
							<td>
								<h1><?=$BuilderEngine->get_option('website_title');?><img style="width:50px;height:30px;float:right;" src="<?=base_url('blocks/contact_form/ei.png')?>" /></h1>
								<br>  
								<table class="row">
									<tr>
										<td class="wrapper">
											<table class="six columns">
												<tr>
													<td style="width:400px;">
														<p style="font-size:12px;"><b> Contact Form Message Received:</b></p>
														<p style="font-size:12px;"><?=$p[4]?></p>
													</td>
										...
										<td class="wrapper">
											<table class="six columns" style="border-left:3px solid #000;">
												<tr>
													<td>
														<h6></h6>
														<table style="width:200px;border-bottom:3px solid #000;margin-left:5px;">
															<tr>
																<td>
																	<?=$p[1]?>
																</td>
