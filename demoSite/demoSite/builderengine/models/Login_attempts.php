...
{
	private $table_name = 'be_user_login_attempts';
	...
	function __construct()
	{
		...
		$ci =& get_instance();
		$this->table_name = 'be_user_login_attempts';
	}
	...
	{
		$this->db->insert($this->table_name, array('ip_address' => $ip_address, 'login' => $login, 'time' => time()));
	}
...
/* Location: ./builderengine/models/login_attempts.php */