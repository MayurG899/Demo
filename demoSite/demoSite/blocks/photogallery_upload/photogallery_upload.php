<?php
class Photogallery_upload_block_handler extends  block_handler{
    function info()
    {
        $info['category_name'] = "Photo Gallery";
        $info['category_icon'] = "dsf";

        $info['block_name'] = "Photo Upload";
    ...
    public function generate_content()
    {
		...
		//View
		$output ='
				<div id="photogallery-upload-'.$this->block->get_id().'">
					<div class="row">		
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div id="uploadFormP" class="photogallery-video-night-bg" style="display:none;">';
							if($num_albums > 0){
								...
								if($num_albums > 0){
								    $disabled = '';
								    $output .='<label class="control-label photogallery-upload-album-label col-md-2 col-sm-2" for="fullname">Select Album:</label>
									<div class="photogallery-upload-album-padding col-md-10 col-sm-10">
										...
										$disabled = 'disabled';
										$output .='<label class="control-label photogallery-upload-album-label col-md-2 col-sm-2" for="fullname"></label>
										<div class="photogallery-upload-album-padding col-md-10 col-sm-10">
								...
								$output .='</div>							
								<div class="form-group">
									<label class="control-label photogallery-upload-album-label col-md-2 col-sm-2" for="fullname">Photo Title:</label>
									<div class="photogallery-upload-album-padding col-md-10 col-sm-10">
										<input class="form-control" type="text" id="title" name="title" placeholder="Photo title" data-parsley-required="true" required />
									</div>
								</div>
								<div class="form-group">
								<label class="control-label photogallery-upload-album-label col-md-2 col-sm-2" for="fullname">Description:</label>
									<div class="photogallery-upload-album-padding col-md-10 col-sm-10">
								...
								<div class="form-group">
								<label class="control-label photogallery-upload-album-label col-md-2 col-sm-2" for="fullname">Tags:</label>
									<div class="photogallery-upload-album-padding col-md-10 col-sm-10">
								...
								<div class="form-group">
									...
									<!--
								   <label class="control-label photogallery-upload-album-label col-md-2 col-sm-2" for="status">Photo Status:</label>
									<div class="photogallery-upload-album-padding col-md-10 col-sm-10">
									...
									-->
									<label class="control-label photogallery-upload-album-label col-md-2 col-sm-2" for="fullname">Allow Comments:</label>
									<div class="photogallery-upload-album-padding col-md-10 col-sm-10">
								...
								<label class="control-label col-md-12 col-sm-12" for="fullname">&nbsp;</label>
									...
									<div class="col-md-10 col-sm-10">
										<button type="submit" class="btn btn-sm btn-primary <?=$disabled?>" name="submit"><i class="fa fa-floppy-o"></i> Publish Photo</button>
									</div>
								</div>
							</form>
						</div>
		...
		if((isset($_SESSION['editoR']) && $_SESSION['editoR']))
			return $output.$this->apply_custom_css().$CI->layout_system->load_new_block_scripts($this->block->get_id(), 'photogallery-upload-'.$this->block->get_id(), $CI->BuilderEngine->get_page_path(), '', $this->block->get_name(), $menu);
		else
