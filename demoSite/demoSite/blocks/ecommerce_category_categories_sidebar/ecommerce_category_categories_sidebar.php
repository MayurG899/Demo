<?php
class ecommerce_category_categories_sidebar_block_handler extends  block_handler{
    function info()
    {
        $info['category_name'] = "Online Store";
        $info['category_icon'] = "dsf";

        $info['block_name'] = "Category sidebar";
    ...
    public function generate_content()
    {
        ...
        $categories_sidebar = $CI->ecommerce->get_categories_sidebar();

        $output = $categories_sidebar;
