<?php
class photogallery_register_info_block_handler extends  block_handler{
    function info()
    {
    ...
    public function generate_content()
    {
		...
		$register_info = $CI->BuilderEngine->get_option('photogallery_register_info');
		
		//View
		$output = '
			<div id="photogallery-register-info-'.$this->block->get_id().'">
		...
		if((isset($_SESSION['editoR']) && $_SESSION['editoR']))
			return $output.$this->apply_custom_css().$CI->layout_system->load_new_block_scripts($this->block->get_id(), 'photogallery-register-info-'.$this->block->get_id(), $CI->BuilderEngine->get_page_path(), '', $this->block->get_name(), $menu);
		else
