<?php
class photogallery_add_album_block_handler extends  block_handler{
    function info()
    {
    ...
    public function generate_content()
    {
		...
		//View
        $output ='
			<div id="photogallery-add-album-'.$this->block->get_id().'">
				<h2 class="text-center">Create New Photo Album</h2>
						<div id="uploadForm" class="photogallery-video-darker-bg">
							<form method="post" id="fors" style="">
								...
								<div class="form-group">
									<label class="control-label photogallery-upload-album-label col-md-3 col-sm-3" for="categoryselection">Parent Album:</label>
									<div class="photogallery-upload-album-padding col-md-7 col-sm-7">								
								...
								<div class="form-group">
									<label class="control-label photogallery-upload-album-label col-md-3 col-sm-3" for="fullname">Album Name:</label>
									<div class="photogallery-upload-album-padding col-md-7 col-sm-7">
										<input class="form-control" type="text" id="name" name="name" placeholder="Album Name" data-parsley-required="true" required />
									</div>
								</div>
								<div class="form-group">
								<label class="control-label photogallery-upload-album-label col-md-3 col-sm-3" for="fullname">Album Status:</label>
									<div class="photogallery-upload-album-padding col-md-7 col-sm-7">
		...
		if((isset($_SESSION['editoR']) && $_SESSION['editoR']))
			return $output.$this->apply_custom_css().$CI->layout_system->load_new_block_scripts($this->block->get_id(), 'photogallery-add-album-'.$this->block->get_id(), $CI->BuilderEngine->get_page_path(), '', $this->block->get_name(), $menu);
		else
