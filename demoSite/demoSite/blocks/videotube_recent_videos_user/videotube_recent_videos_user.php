<?php
class Videotube_recent_videos_user_block_handler extends  block_handler{
    function info()
    {
        $info['category_name'] = "VideoTube";
        $info['category_icon'] = "dsf";

        $info['block_name'] = "Recent User Videos";
    ...
    public function generate_content()
    {
		...
		$videos = $videos->where('user_id',$channel_owner->id)->order_by('time_created','desc')->get();
        $page_number = 1;
        if(isset($_GET['page'])){
