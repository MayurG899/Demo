<?php
class photogallery_bottom_slider_block_handler extends  block_handler{
    function info()
    {
    ...
    public function generate_content()
    {
		...
		//View
		$output = '
		<div id="photogallery-bottom-slider-'.$this->block->get_id().'"><hr />
        <!-- Work Next Prev Bar -->
                <div class="item-nav">';	
					...
					$link1 = (!empty($user_galleries))?base_url('photogallery/channel/'.$user_galleries[0].''):base_url('photogallery/channel/'.$channel_owner->username.'');
					$link2 = (!empty($user_galleries))?base_url('photogallery/channel/'.end($user_galleries).''):base_url('photogallery/channel/'.$channel_owner->username.'');
                    ...
                    <a href="'.base_url('photogallery/channel/'.$channel_owner->username).'" class="item-all-view">
                        <h4>'.$channel_owner->first_name.' '.$channel_owner->last_name.' Member Gallery</h4>
                    </a>
		...
		if((isset($_SESSION['editoR']) && $_SESSION['editoR']))
			return $output.$this->apply_custom_css().$CI->layout_system->load_new_block_scripts($this->block->get_id(), 'photogallery-bottom-slider-'.$this->block->get_id(), $CI->BuilderEngine->get_page_path(), '', $this->block->get_name(), $menu);
		else
