<?php
class photogallery_channel_block_handler extends  block_handler{
    function info()
    {
    ...
    public function generate_content()
    {
		...
		//View
        $output ='
			<div id="photogallery-channel-'.$this->block->get_id().'">
			<!-- Work Detail Section -->
				<div class="">
					<p class="photogallery-featured-title-3">Photo Wall</p>
				</div>
         ...
         $output .='</ul>
                ...
                <div class="container-masonry nf-col-3" style="">';
					foreach($photos as $photo){
						...
						$output .='	<div class="nf-item '.$photo_album->name.' photogallery-galleryboxspace">
		...
		if((isset($_SESSION['editoR']) && $_SESSION['editoR']))
			return $output.$this->apply_custom_css().$CI->layout_system->load_new_block_scripts($this->block->get_id(), 'photogallery-channel-'.$this->block->get_id(), $CI->BuilderEngine->get_page_path(), '', $this->block->get_name(), $menu);
		else
