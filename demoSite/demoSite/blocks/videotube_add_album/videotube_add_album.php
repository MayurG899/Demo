<?php
class Videotube_add_album_block_handler extends  block_handler{
    function info()
    {
    ...
    public function generate_content()
    {
        ...
        $output ='
				<h2 class="text-center">Create New Video Album</h2>
						<div id="uploadForm" class="video-darker-bg">
							<form method="post" id="fors" style="">
								<input type="hidden" name="image" value="'.base_url('builderengine/public/img/video_placeholder.png').'">
								<style>.control-label{color:#fff;}</style>
								<div class="form-group">
									<label class="control-label video-upload-album-label col-md-3 col-sm-3" for="categoryselection">Parent Album:</label>
									<div class="video-upload-album-padding col-md-7 col-sm-7">								
								...
								<div class="form-group">
									<label class="control-label video-upload-album-label col-md-3 col-sm-3" for="fullname">Album Name:</label>
									<div class="video-upload-album-padding col-md-7 col-sm-7">
										<input class="form-control" type="text" id="name" name="name" placeholder="Album Name" data-parsley-required="true" required />
									</div>
								</div>
								<div class="form-group">
								<label class="control-label video-upload-album-label col-md-3 col-sm-3" for="fullname">Album Status:</label>
									<div class=" video-upload-album-padding col-md-7 col-sm-7">
