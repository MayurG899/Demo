<?php
class ecommerce_product_featured_products_block_handler extends  block_handler{
    function info()
    {
        $info['category_name'] = "Online Store";
        $info['category_icon'] = "dsf";

        $info['block_name'] = "Featured products";
    ...
    public function generate_content()
    {
        ...
        $featured_products = $CI->ecommerce->get_featured_products('all', true);

        $output = $featured_products;
