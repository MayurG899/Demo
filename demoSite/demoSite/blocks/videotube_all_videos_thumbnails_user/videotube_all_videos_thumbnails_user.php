<?php
class Videotube_all_videos_thumbnails_user_block_handler extends  block_handler{
    function info()
    {
        $info['category_name'] = "VideoTube";
        $info['category_icon'] = "dsf";

        $info['block_name'] = "All User Video Thumbnails";
    ...
    public function generate_content()
    {
		...
		$videos = $CI->videotubemedia->where('user_id',$usr->id)->get();
