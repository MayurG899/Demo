<?php
class Videotube_add_youtube_block_handler extends  block_handler{
    function info()
    {
        $info['category_name'] = "VideoTube";
        $info['category_icon'] = "dsf";

        $info['block_name'] = "Add YouTube Link";
    ...
    public function generate_content()
    {
		...
		$output ='<div class="row">	
					<h2 class="text-center">Add <i class="fa fa-youtube"></i> YouTube Video</h2>
						...
						<div id="uploadForm" class="video-night-bg">';
							...
							$output .='
								...
								<div class="form-group">
									<label class="control-label video-upload-album-label col-md-2 col-sm-2" for="fullname">YouTube Video URL:</label>
									<div class="video-upload-album-padding col-md-10 col-sm-10">
										<input class="form-control" id="uploadedFile" type="text" name="media_file" placeholder="YouTube Video URL">
									</div>
								</div>
								<div class="form-group">';
								if($num_albums > 0){
