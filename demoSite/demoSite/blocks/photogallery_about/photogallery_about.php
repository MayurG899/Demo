<?php
class photogallery_about_block_handler extends  block_handler{
    function info()
    {
    ...
    public function generate_content()
    {
		...
		$owner_settings = $CI->photogalleryusersettings->where('user_id',$channel_owner->id)->get();
		...
		$views = $CI->visits
			->where('page','photogallery/channel/'.$username.'')
			->or_where('page','photogallery/channel/'.$username.'/photos')
			->or_where('page','photogallery/channel/'.$username.'/albums')
			->or_where('page','photogallery/channel/'.$username.'/discussion')
			->or_where('page','photogallery/channel/'.$username.'/about')
		->count();

		//View
        $output ='
			<div id="photogallery-about-'.$this->block->get_id().'">
				<!-- Work Detail Section -->
				<div class="row">
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<h4 class="text-center">About '.$channel_owner->first_name.' '.$channel_owner->last_name.'</h4>
						<div class="well">';
					...
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						...
						<p class=""><b>Followers:</b> '.$followers.'</p>
		...
		if((isset($_SESSION['editoR']) && $_SESSION['editoR']))
			return $output.$this->apply_custom_css().$CI->layout_system->load_new_block_scripts($this->block->get_id(), 'photogallery-about-'.$this->block->get_id(), $CI->BuilderEngine->get_page_path(), '', $this->block->get_name(), $menu);
		else
