...
class column_block_handler extends  block_handler{
        ...
        public function register_admin_options()
        {
			...
			$this->add_class_toggle_option('collapse_toggle', '<i class="fa fa-minus collapse-section be-simple-editor-header-minus" title="Hide Column"></i>', 'inverse', false);
        }
        ...
        public function generate_content()
        {
			...
			if((isset($_SESSION['editoR']) && $_SESSION['editoR']))
				return $output.$CI->layout_system->load_section_script($this->block->get_id(), $CI->BuilderEngine->get_page_path(), 'column', $this->block->get_name(), $menu);
			else
				return $output;
        }
	}
