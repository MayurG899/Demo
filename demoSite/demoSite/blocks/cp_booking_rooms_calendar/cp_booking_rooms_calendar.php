<?php
class Cp_booking_rooms_calendar_block_handler extends  block_handler{
    function info()
    {
        $info['category_name'] = "Account Dashboard";
        $info['category_icon'] = "dsf";

        $info['block_name'] = "Account Dashboard Booking Rooms Calendar";
						...
						<div class="col-md-12">
							<div class="panel panel-cp-account">
								<div class="panel-heading">
									...
									<h4 class="panel-title">Booking Rooms Calendar</h4>
									<br>
									<!--
													...
													<div class="tab-pane fade ';if(isset($_GET['room']) && $_GET['room'] == $department->id) $output .= 'active in';$output .='" id="nav-tab2-'.$department->id.'" style="padding:10px">
														<h4 class="m-t-10">';
															if(!empty($department->image)){
																$output .='<img src="'.$department->image.'" class="img-responsive bookingrooms-calendar-logo"/>';
															}
															$output .='
								...
								<form id="editBooking" method="post" data-parsley-validate="true">
									...
									<div class="modal-footer">
										...
										<div class="col-lg-12">
											...
											<button id="cancelR" type="button" class="btn btn-sm btn-gray" data-dismiss="modal"><i class="fa fa-times"></i> Cancel</button>
							...
							<div class="modal-content">
								<form id="addNewBooking" method="post" data-parsley-validate="true">
									...
									<div class="modal-footer">
										...
										<div class="col-lg-12">
											<button type="button" class="btn btn-sm btn-gray" data-dismiss="modal"><i class="fa fa-times"></i> Cancel</button>
										...
										<form id="editBooking'.$department->id.'" method="post" data-parsley-validate="true">
											...
											<div class="modal-footer">
												...
												<div class="col-lg-12">
													...
													<button id="cancelR'.$department->id.'" type="button" class="btn btn-sm btn-gray" data-dismiss="modal"><i class="fa fa-times"></i> Cancel</button>
							...
							<div id="errModal'.$department->id.'" class="modal fade">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-footer">
											<button type="button" class="btn btn-sm btn-gray" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
										</div>
									</div>
								</div>
							</div>
