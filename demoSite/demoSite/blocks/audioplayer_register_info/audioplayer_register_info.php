<?php
class Audioplayer_register_info_block_handler extends  block_handler{
    function info()
    {
    ...
    public function generate_content()
    {
		...
		$register_info = $CI->BuilderEngine->get_option('audioplayer_register_info');
		$this->load_generic_styling();
		//View
		$output = '
		<div id="audioplayer-register-info-'.$this->block->get_id().'">
		...
		if((isset($_SESSION['editoR']) && $_SESSION['editoR']))
			return $output.$CI->layout_system->load_new_block_scripts($this->block->get_id(), 'audioplayer-register-info-'.$this->block->get_id(), $CI->BuilderEngine->get_page_path(), '', $this->block->get_name(), $menu);
		else
			return $output;
    }
}
